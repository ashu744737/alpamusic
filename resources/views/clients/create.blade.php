...
@section('title') {{trans('form.registration.client.create_client_title')}} @endsection
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <h4 class="card-title">{{trans('form.registration.client.create_client_title')}}</h4>
                            <p class="card-title-desc">{{trans('form.registration.client.create_client_desc')}}</p>
                        </div>

                        <div class="col-12">

                            <form name="client-form" id="client-form" class="form-horizontal mt-4" method="POST" action="{{ route('client.store') }}" onSubmit="return dosubmit();" >
