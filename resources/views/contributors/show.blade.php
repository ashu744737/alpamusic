...
@section('title') {{ trans('form.registration.investigator.viewform.investigators_details') }} @endsection
    ...
    <div class="col-sm-6">
        <div class="page-title-box">
            <ol class="breadcrumb m-0">
                <li class="breadcrumb-item"><a href="{{route('investigators')}}">{{ trans('form.registration.investigator.viewform.investigators') }}</a></li>
                        ...
                        <div class="col-12">
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane active py-3" id="basic_details" role="tabpanel">
                                    ...
                                    <hr />
                                    <h4 class="section-title mb-3 pb-2">{{ trans('form.registration.investigator.viewform.area_of_specialization') }}</h4>
                                    <div class="row">
                                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                              <div>
                                                    @foreach($user->investigatorspecilizations as $specialize) 
                                                    @if ($specialize->specializations->name || $specialize->specializations->hr_name)   
                                                    <span class="badge dt-badge badge-primary">
                                                    @if(config('app.locale') == 'hr')
                                                        {{ $specialize->specializations->hr_name ?? '' }}
                                                    @else
                                                        {{ $specialize->specializations->name ?? '' }}
                                                    @endif
                                                    </span>
                                                    @endif
                                                    @endforeach   
                                            ...
                                            <div class="card">
                                                ...
                                                <div class="card-body">
                                                    <blockquote class="card-blockquote mb-0">
                                                        ...
                                                        <p> {{ $mobile->value ?? '' }} @if ($mobile->phone_type!='')<span class="badge badge-primary">
                                                            @if(config('app.locale') == 'hr')
                                            ...
                                            <div class="card">
                                                ...
                                                <div class="card-body">
                                                    <blockquote class="card-blockquote mb-0">
                                                        ...
                                                        <p> {{ $email->value ?? '' }} @if ($email->email_type!='')<span class="badge badge-primary">
                                                            @if(config('app.locale') == 'hr')
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-lg-6 col-xl-6">
                                            <div class="form-group row">
                                                <label for="inv_name"
                                                    class="col-4">{{ trans('form.registration.investigator.viewform.company') }}</label>
                                                <div class="col-8">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-lg-6 col-xl-6">
                                            <div class="form-group row">
                                                <label for="inv_name"
                                                    class="col-4">{{ trans('form.registration.investigator.viewform.bank_number') }}</label>
                                                <div class="col-8">
                                        ...
                                        <div class="col-md-6 col-lg-6 col-xl-6">
                                            <div class="form-group row">
                                                <label for="inv_name"
                                                    class="col-4">{{ trans('form.registration.investigator.viewform.branch_name') }}</label>
                                                <div class="col-8">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-lg-6 col-xl-6">
                                            <div class="form-group row">
                                                <label for="inv_name"
                                                    class="col-4">{{ trans('form.registration.investigator.viewform.branch_no') }}</label>
                                                <div class="col-8">
                                        ...
                                        <div class="col-md-6 col-lg-6 col-xl-6">
                                            <div class="form-group row">
                                                <label for="inv_name"
                                                    class="col-4">{{ trans('form.registration.investigator.viewform.account_no') }}</label>
                                                <div class="col-8">
