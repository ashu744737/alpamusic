                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-12 col-sm-4 col-xs-12">
                            <h4 class="card-title">{{ trans('form.investigators') }} {{ trans('general.payment') }}</h4>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <table id="datatable_investigation_invoice" class="table table-bordered dt-responsive">
                                <thead>
                                <tr role="row">
                                    <th class="noVis"></th>
                                    <th class="noVis"></th>
                                    @if(isAdmin())
                                    <th>{{ trans('form.client_approval.client_name_title_inv') }}</th>
                                    ...
                                    <th>{{ trans('form.invoice.performa_issued') }}</th>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form method="POST" class="" id="investigatorFileuploadform"
                        action="{{ route('investigator-bulk-invoice-pay') }}"
...
@section('footerScript')
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            cDTable = $('#datatable_investigation_invoice').DataTable({
                // dom: 'lBfrtip',
            ...
            var myInvestigatorDropzone = new Dropzone("#investigatorFileupload", {
                url: '{{ route('investigator-bulk-invoice-pay') }}',
            ...
            $("#investigatorFileuploadform").validate({
                ...
                submitHandler: function(form) {
                    ...
                    if(myInvestigatorDropzone.files.length==0){
                        ...
                        var data=$("#investigatorFileuploadform").serialize();
