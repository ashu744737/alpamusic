...
@section('title') {{ trans('form.performainvoices') }} @endsection
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-12 col-sm-4 col-xs-12">
                            <h4 class="card-title">{{ trans('form.performainvoices') }}</h4>
                        </div>
                    </div>
                        ...
                        <div class="col-12">
                            ...
                            <table id="datatable_invoice" class="table table-bordered dt-responsive">
                                ...
                                <tr role="row">
                                    ...
                                    <th>{{ trans('form.registration.investigation.created_by') }}</th>
                                    <th>{{ trans('general.created_at') }}</th>
                                    <th>{{ trans('form.invoice.status') }}</th>
                                    <th>{{ trans('form.invoice.due_date') }}</th>
        ...
        $(document).ready(function() {
            ...
            function markAsPaidRecords(){
                ...
                if(rows_selected.length > 0){
                    ...
                    // $.ajax({
                    //     url: "{{ route('investigation.showinvoices') }}",
                    //     type: 'POST',
                    //     dataType: 'json',
                    //     data: {
                    //         "ids": ids,
