                ...
                <div class="col-md-8 col-lg-6 col-xl-5">
                    <div class="card overflow-hidden">
                        <div class="card-body pt-0">
                            ...
                            <div class="p-3">
                                <p class="text-muted text-center">{{ trans('form.email_tem.verification.welcome_text') }}</p>
                            <p class="text-muted text-center">{{ trans('form.email_tem.verification.click_verify') }} {{ $user->email ?? '' }}</p>
                            <a href="{{ url('user/verify', $user->verify_token ?? '')}}">{{ trans('form.email_tem.verification.verify_email') }}</a>
                            <br/>
