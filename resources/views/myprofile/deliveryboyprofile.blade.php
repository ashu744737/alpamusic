                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="tab-content">
                                ...
                                <div id="old_profile">
                                    @include('myprofile.clientajax.personaldetail', ['type'=>'deliveryboy','user' => $user])
                                ...
                                <div class="d-none" id="edit_profile">
                                        ...
                                        <div class="form-group col-md-4">
                                         ...
                                         <div class="form-group col-md-4">
                                            <label>{{ trans('form.registration.investigator.family') }} </label>
                                                                <input type="text" value="{{ $user->deliveryboy->family }}" class="form-control" id="family" name="family" placeholder="{{ trans('form.registration.investigator.family') }}">
                                                                @error('family')
                                                                <span class="invalid-feedback" role="alert">
                                                                <strong>{{ $message }}</strong>
                                                                </span>
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-4">
                                            <label>{{ trans('form.registration.investigator.id_number') }} </label>
                                                                <input type="text" value="{{ $user->deliveryboy->idnumber}}" class="form-control" id="idnumber" name="idnumber" placeholder="{{ trans('form.registration.investigator.id_number') }}">
                                                                @error('idnumber')
                                                                <span class="invalid-feedback" role="alert">
                                                                <strong>{{ $message }}</strong>
                                                                </span>
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text" value="{{ $user->deliveryboy->website }}" class="form-control" id="website" name="website" placeholder="{{ trans('form.registration.client.website') }}">
                                            @error('website')
                                            <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                            </span>
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <div class="input-group">
                                                <input type="text" class="form-control" placeholder="{{trans('general.date_format')}}" id="dob" name="dob" value="{{ date('d/m/Y', strtotime($user->deliveryboy->dob)) }}">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-12">
                                            ...
                                            <select required multiple="multiple" class="select2 form-control select2-multiple input_required_s2" id="deliveryarea_id" name="deliveryarea_id[]" data-placeholder="{{ trans('form.registration.investigator.fos_helper') }}">
                                                @foreach($deliveryareas as $id => $deliveryarea)
                                                                        <option value="{{ $deliveryarea['id'] }}" {{ in_array($deliveryarea['id'], $areas) == $deliveryarea['id'] ? 'selected' : '' }}>{{ config('app.locale') == 'hr'?$deliveryarea['hr_area_name']:$deliveryarea['area_name'] }}</option>
                                                                    @endforeach
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <hr />
                                    ...
                                    <div id="old_bank">
                                        @include('myprofile.clientajax.bankdetails', ['type'=>'deliveryboy','user' => $user])
                                           ...
                                           <div class="form-row">
                                            <div class="form-group col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input value="{{  !is_null($user->deliveryboy->deliveryboyBankDetail)?$user->deliveryboy->deliveryboyBankDetail->company:'' }}" type="text" class="form-control input_required_s3 @error('company') is-invalid @enderror" name="company" id="company" placeholder="{{ trans('form.registration.investigator.company') }}">
                                                    @error('company')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                            ...
                                            <div class="form-group col-md-4">
                                                <div class="form-group">
                                                    <label for="name_of_bank">{{ trans('form.registration.investigator.name_of_bank') }} <span class="text-danger">*</span>
                                                                ...
                                                                <select id="name_of_bank"
                                                                    ...
                                                                    <option value="FIBI" {{ (!is_null($user->deliveryboy->deliveryboyBankDetail) && $user->deliveryboy->deliveryboyBankDetail->name == 'FIBI') ? 'selected' : '' }}>{{trans('form.name_of_bank.FIBI')}}</option>
                                                                    <option value="PNC" {{ (!is_null($user->deliveryboy->deliveryboyBankDetail) && $user->deliveryboy->deliveryboyBankDetail->name == 'PNC') ? 'selected' : '' }}>{{trans('form.name_of_bank.PNC')}}</option>
                                                                    <option value="CitiGroup" {{ (!is_null($user->deliveryboy->deliveryboyBankDetail) &&$user->deliveryboy->deliveryboyBankDetail->name == 'CitiGroup') ? 'selected' : '' }}>{{trans('form.name_of_bank.CitiGroup')}}</option>
                                                                </select>
                                             ...
                                             <div class="form-group col-md-4">
                                                <label for="bank_number">{{ trans('form.registration.investigator.bank_number') }} <span class="text-danger">*</span></label>
                                                                <input type="text"
                                                                       value="{{ !is_null($user->deliveryboy->deliveryboyBankDetail)?$user->deliveryboy->deliveryboyBankDetail->number:'' }}"
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-4">
                                                <label for="branch_name">{{ trans('form.registration.investigator.branch_name') }} <span class="text-danger">*</span></label>
                                                                <input value="{{ !is_null($user->deliveryboy->deliveryboyBankDetail)?$user->deliveryboy->deliveryboyBankDetail->branch_name:'' }}" type="text" class="form-control input_required_s3 @error('branch_name') is-invalid @enderror" name="branch_name" id="branch_name" placeholder="{{ trans('form.registration.investigator.branch_name') }}">
                                                                @error('branch_name')
                                                                <span class="invalid-feedback" role="alert">
                                                                    <strong>{{ $message }}</strong>
                                                                </span>
                                            ...
                                            <div class="form-group col-md-4">
                                                <label for="branch_no">{{ trans('form.registration.investigator.branch_no') }} <span class="text-danger">*</span></label>
                                                                <input value="{{ !is_null($user->deliveryboy->deliveryboyBankDetail)?$user->deliveryboy->deliveryboyBankDetail->branch_number:'' }}" type="text" class="form-control input_required_s3 @error('branch_no') is-invalid @enderror" name="branch_no" id="branch_no" placeholder="{{ trans('form.registration.investigator.branch_no') }}">
                                                                @error('branch_no')
                                                                <span class="invalid-feedback" role="alert">
                                                                    <strong>{{ $message }}</strong>
                                                                </span>
                                            ...
                                            <div class="form-group col-md-4">
                                                <label for="account_no">{{ trans('form.registration.investigator.account_no') }} <span class="text-danger">*</span></label>
                                                                <input value="{{ !is_null($user->deliveryboy->deliveryboyBankDetail)?$user->deliveryboy->deliveryboyBankDetail->account_no:'' }}" type="text" class="form-control input_required_s3 @error('account_no') is-invalid @enderror" name="account_no" id="account_no" placeholder="{{ trans('form.registration.investigator.account_no') }}">
                                                                @error('account_no')
                                                                <span class="invalid-feedback" role="alert">
                                                                    <strong>{{ $message }}</strong>
                                                                </span>
