<div class="col-xl-4">
    <div class="card">
        <div class="card-body">
            <h4 class="card-title mb-4">{{trans('form.dashboard_screen.completevsincomplete')}}</h4>
           
            <div id="complete_incomplete_client" class="morris-charts morris-charts-height" dir="ltr"></div>
        </div>
    </div>
</div>
<!-- Client Monthly Investigations -->
<div class="col-xl-8">
    <div class="card">
        <div class="card-body">
            <div class="row">
...
<!-- End Client Monthly Investigations -->

{{-- client time_per_case_type --}}
    ...
    <div class="card">
        <div class="card-body">
            <div class="row mb-2 ml-2">
                <h4 class="card-title mt-2 mb-2">{{trans('form.invoices')}}</h4>
                <a id="open-invoice" class="btn ml-2" data-toggle="tab" href="#open_invoice" role="tab">{{trans('form.ticket.open')}}</a>
                <a id="close-invoice" class="btn" data-toggle="tab" href="#close_invoice" role="tab">{{trans('form.ticket.close')}}</a>
            </div>

            <div class="tab-pane table-responsive" id="open_invoice_data" role="tabpanel">
                <table class="table table-centered table-vertical table-nowrap">

                    <tbody id="open_invoice">
                    </tbody>
                </table>
            </div>

            <div class="tab-pane table-responsive" id="close_invoice_data" role="tabpanel">
                <table class="table table-centered table-vertical table-nowrap">

                    <tbody id="close_invoice">
...
<div class="col-xl-12 d-none">
    <div class="card">
        <div class="card-body">
            <div class="row ml-2">
                <div class="col-12 col-xl-9 col-md-6 col-sm-6">
                    <h4 class="card-title mb-4">{{trans('form.dashboard_screen.late_investigations')}}</h4>
                </div>
                <div class="actiondropdown col-12 col-xl-3 col-sm-6 text-sm-right">
                    <div class="dropdown dropdown-topbar d-inline-block">
                        <a class="btn btn-light" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            ...
            <div id="late-investigations" class="morris-charts morris-charts-height" dir="ltr" style="height: 370px;overflow: auto;"></div>
        </div>
    </div>
</div>