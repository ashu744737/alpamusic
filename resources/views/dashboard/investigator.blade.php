<div class="col-xl-4">
    <div class="card">
        <div class="card-body">
            ...
            <div id="complete_incomplete_investigation" class="morris-charts morris-charts-height" dir="ltr"></div>
        </div>
    </div>
</div>
 <!-- Investigator Monthly Investigations -->
 <div class="col-xl-8">
    <div class="card">
        <div class="card-body">
            <div class="row">
...
<!-- End Investigator Monthly Investigations -->
{{-- investigator time_per_case_type --}}
<div class="col-xl-6">
    <div class="card">
        <div class="card-body">
            <div class="row">
...
{{--  end investigator time_per_casetime_per_case_type --}}