    ...
    {{-- <div class="col-xl-4">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title mb-4">{{trans('form.dashboard_screen.income_outcome')}}</h4>

                <div class="row text-center mt-4">
                    <div class="col-6">
                        <h5 class="font-size-20" id="totalOutcome"></h5>
                        <p class="text-muted">{{trans('form.dashboard_screen.outcome')}}</p>
                    </div>
                    <div class="col-6">
                        <h5 class="font-size-20" id="totalIncome"></h5>
                        <p class="text-muted">{{trans('form.dashboard_screen.income')}}</p>
                    </div>
                </div>

                <div id="income_outcome_chart" class="morris-charts morris-charts-height" dir="ltr"></div>
            </div>
        </div>
    </div> --}}
    <!-- End Income vs Outcome Chart -->
    ...
    {{-- <div class="col-xl-8">
        <div class="card">
            <div class="card-body">
                ...
                <div class="tab-pane table-responsive" id="pending_investigations_data" role="tabpanel" style="height: 370px;overflow: auto;">
                ...
                <div class="tab-pane table-responsive" id="pending_clients_data" role="tabpanel" style="height: 370px;overflow: auto;">
                    <table class="table table-centered table-vertical table-nowrap">
                ...
                <div class="tab-pane table-responsive" id="pending_investigators_data" role="tabpanel" style="height: 370px;overflow: auto;">
                    <table class="table table-centered table-vertical table-nowrap">
                ...
                <div class="tab-pane table-responsive" id="pending_delivery_boys_data" role="tabpanel" style="height: 370px;overflow: auto;">
                    <table class="table table-centered table-vertical table-nowrap">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-12 col-xl-12 col-md-12 col-sm-12">
                        <h4 class="card-title mb-4">{{trans('form.dashboard_screen.income_per_emp')}}</h4>
                    </div>
                </div>
                <div id="monthly-income-employee-div" dir="ltr" style="height: 370px;overflow: auto;">
                    <table class="table table-centered table-vertical table-nowrap">
                        <tbody id="monthly-income-employee-tab">
                        </tbody>
                    </table>
                </div>
            </div>
    ...
    {{-- <div class="col-xl-6">
        <div class="card">
            <div class="card-body">
                ...
                <div id="monthly-complaints-div" dir="ltr" style="height: 370px;overflow: auto;">
                    <table class="table table-centered table-vertical table-nowrap">
