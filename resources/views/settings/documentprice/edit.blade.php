...
@section('title') {{ trans('form.documenttypes.edit_document_types') }} @endsection
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-12 col-sm-4 col-xs-12">
                            <h4 class="card-title">{{ trans('form.documenttypes.edit_document_types') }}</h4>
                        </div>
                    </div>
                    @include('session-message')
                    <div class="row mt-3">
                        <div class="col-12">
                            <form action="{{ route('documentprice.update', ['docprice_id' => $doctype->id]) }}" method="POST" id="edit_product" class="form needs-validation">
                                @csrf
                                
                                <div class="form-row">
                                    <div class="form-group col-md-12">
                                        <label for="name" class="ul-form__label">{{ trans('form.documenttypes.name') }} <span class="text-danger">*</span></label>
                                        <input  type="text" class="form-control" id="name" name="name" placeholder="{{ trans('form.documenttypes.name') }}" value="{{ old('name') ? old('name') : $doctype->name }}"  />
                                        @error('name')
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-12">
                                        ...
                                        <input  type="text" class="form-control" id="hr_name" name="hr_name" placeholder="{{ trans('form.documenttypes.hebrew_name') }}" value="{{ old('hr_name') ? old('hr_name') : $doctype->hr_name }}"  />
                                        @error('hr_name')
                                        <span class="invalid-feedback d-block" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-12">
                                        ...
                                        <input  type="text" class="form-control" id="price" name="price" placeholder="{{trans('form.documenttypes.price')}}" value="{{ old('price') ? old('price') : $doctype->price }}" />
                                        @error('price')
                                        <span class="invalid-feedback d-block" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9 col-xl-9">
                                                <input name="include_vat" id="include_vat" type="checkbox" switch="bool" {{ $doctype->include_vat == 1 ? 'checked' : '' }} />
                                ...
                                <div class="form-row">
                                    <div class="col-md-12 mb-4">
                                        <input type="hidden" name="docprice_id" value="{{ $doctype->id }}" />
