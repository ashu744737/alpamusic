...
@section('title') {{trans('form.registration.investigator.edit_investigator_title')}} @endsection
    ...
    <div class="col-sm-6">
        <div class="page-title-box">
            <ol class="breadcrumb m-0">
                <li class="breadcrumb-item"><a href="{{route('investigators')}}">{{ trans('form.investigators') }}</a></li>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <h4 class="card-title">{{trans('form.registration.investigator.edit_investigator_title')}}</h4>
                            <p class="card-title-desc">{{trans('form.registration.investigator.edit_investigator_desc')}}</p>
                        </div>

                        <div class="col-12">

                            <form name="investigator-form" id="investigator-form" class="form-horizontal mt-4" method="POST" action="{{ route('investigator.update', $client->id) }}" onSubmit="return dosubmit();" >
                                                    ...
                                                    <div id="next_step2">
                                                        ...
                                                        <div class="form-row">
                                                            <div class="form-group col-md-4">
                                                                ...
                                                                <input type="text" value="{{ old('family', $client->investigator->family) }}" class="form-control" id="family" name="family" placeholder="{{ trans('form.registration.investigator.family') }}">
                                                                @error('family')
                                                                <span class="invalid-feedback" role="alert">
                                                                <strong>{{ $message }}</strong>
                                                                </span>
                                                            ...
                                                            <div class="form-group col-md-4">
                                                                ...
                                                                <input type="text" value="{{ old('idnumber', $client->investigator->idnumber) }}" class="form-control" id="idnumber" name="idnumber" placeholder="{{ trans('form.registration.investigator.id_number') }}">
                                                                @error('idnumber')
                                                                <span class="invalid-feedback" role="alert">
                                                                <strong>{{ $message }}</strong>
                                                                </span>
                                                            ...
                                                            <div class="form-group col-md-4">
                                                                ...
                                                                <input type="text" value="{{ old('idnumber', $client->investigator->website) }}" class="form-control" id="website" name="website" placeholder="{{ trans('form.registration.client.website') }}">
                                                                @error('website')
                                                                <span class="invalid-feedback" role="alert">
                                                                <strong>{{ $message }}</strong>
                                                                </span>
                                                        ...
                                                        <div class="form-row">
                                                            <div class="form-group col-md-6">
                                                                ...
                                                                <select multiple="multiple" class="select2 form-control select2-multiple input_required_s2" id="specializations" name="specializations[]" data-placeholder="{{ trans('form.registration.investigator.fos_helper') }}">
                                                                    @foreach($specializations as $id => $specialization)
                                                                        <option value="{{ $specialization['id'] }}" {{ old('specializations', in_array($specialization['id'], $specs)) == $specialization['id'] ? 'selected' : '' }}>
                                                                        {{ App::isLocale('hr')?$specialization['hr_name']:$specialization['name'] }}
                                                                        </option>
                                                                    @endforeach
                                                                </select>
                                                            </div>
                                                            ...
                                                            <div class="form-group col-md-6">
                                                                ...
                                                                <div class="input-group">
                                                                    <input type="text" class="form-control" placeholder="{{trans('general.date_format')}}" id="dob" name="dob" value="{{ old('dob', date('d/m/Y', strtotime($client->investigator->dob))) }}">
                                                                             ...
                                                                             <div class="card-body">
                                                                                     ...
                                                                                     <div class="form-row">
                                                                                         ...
                                                                                         <div class="form-group col-md-4">
                                                                                             ...
                                                                                             <select id="arr_otherfax_type_{{$faxIndx}}" onchange="changeotheroldtextbox(this)" name="otherfax[{{$faxIndx}}][fax_type]" class="form-control arr_otherfax_type">
										...
										<!-- end Block for multiple fax-->
                                                        ...
                                                        <div class="form-row">
                                                            <div class="form-group col-md-12">
                                                                ...
                                                                <input value="{{ old('bank_number', !is_null($client->investigator->investigatorBankDetail)?$client->investigator->investigatorBankDetail->company:'') }}" type="text" class="form-control @error('company') is-invalid @enderror" name="company" id="company" placeholder="{{ trans('form.registration.investigator.company') }}">
                                                                @error('company')
                                                                <span class="invalid-feedback" role="alert">
                                                                    <strong>{{ $message }}</strong>
                                                                </span>
                                                        ...
                                                        <div class="form-row">
                                                            <div class="form-group col-md-6">
                                                                ...
                                                                <input value="{{ old('name_of_bank', !is_null($client->investigator->investigatorBankDetail)?$client->investigator->investigatorBankDetail->name:'') }}" type="text" class="form-control  @error('name_of_bank') is-invalid @enderror" name="name_of_bank" id="name_of_bank" placeholder="{{ trans('form.registration.investigator.name_of_bank') }}">
                                                                @error('name_of_bank')
                                                                <span class="invalid-feedback" role="alert">
                                                                    <strong>{{ $message }}</strong>
                                                                </span>
                                                            ...
                                                            <div class="form-group col-md-6">
                                                                ...
                                                                <input type="text"
                                                                       value="{{ old('bank_number', ($client->investigator->investigatorBankDetail)?$client->investigator->investigatorBankDetail->number:'') }}"
                                                        ...
                                                        <div class="form-row">
                                                            <div class="form-group col-md-4">
                                                                ...
                                                                <input value="{{ old('branch_name',($client->investigator->investigatorBankDetail)?$client->investigator->investigatorBankDetail->branch_name:'') }}" type="text" class="form-control @error('branch_name') is-invalid @enderror" name="branch_name" id="branch_name" placeholder="{{ trans('form.registration.investigator.branch_name') }}">
                                                                @error('branch_name')
                                                                <span class="invalid-feedback" role="alert">
                                                                    <strong>{{ $message }}</strong>
                                                                </span>
                                                            ...
                                                            <div class="form-group col-md-4">
                                                                ...
                                                                <input value="{{ old('branch_no', ($client->investigator->investigatorBankDetail)?$client->investigator->investigatorBankDetail->branch_number:'') }}" type="text" class="form-control @error('branch_no') is-invalid @enderror" name="branch_no" id="branch_no" placeholder="{{ trans('form.registration.investigator.branch_no') }}">
                                                                @error('branch_no')
                                                                <span class="invalid-feedback" role="alert">
                                                                    <strong>{{ $message }}</strong>
                                                                </span>
                                                            ...
                                                            <div class="form-group col-md-4">
                                                                ...
                                                                <input value="{{ old('account_no', ($client->investigator->investigatorBankDetail)?$client->investigator->investigatorBankDetail->account_no:'') }}" type="text" class="form-control  @error('account_no') is-invalid @enderror" name="account_no" id="account_no" placeholder="{{ trans('form.registration.investigator.account_no') }}">
                                                                @error('account_no')
                                                                <span class="invalid-feedback" role="alert">
                                                                    <strong>{{ $message }}</strong>
                                                                </span>
