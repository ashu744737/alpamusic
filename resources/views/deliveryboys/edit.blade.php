...
@section('title') {{trans('form.registration.deliveryboy.edit_deliveryboy_title')}} @endsection
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <h4 class="card-title">{{trans('form.registration.deliveryboy.edit_deliveryboy_title')}}</h4>
                            <p class="card-title-desc">{{trans('form.registration.deliveryboy.edit_deliveryboy_desc')}}</p>
                        </div>

                        <div class="col-12">

                            <form name="deliveryboy-form" id="deliveryboy-form" class="form-horizontal mt-4" method="POST" action="{{ route('deliveryboy.update', $client->id) }}" onSubmit="return dosubmit();" >
                                                    ...
                                                    <div id="next_step2">
                                                        ...
                                                        <div class="form-row">
                                                            <div class="form-group col-md-4">
                                                                ...
                                                                <input type="text" value="{{ old('family', $client->deliveryboy->family) }}" class="form-control" id="family" name="family" placeholder="{{ trans('form.registration.investigator.family') }}">
                                                                @error('family')
                                                                <span class="invalid-feedback" role="alert">
                                                                <strong>{{ $message }}</strong>
                                                                </span>
                                                            ...
                                                            <div class="form-group col-md-4">
                                                                ...
                                                                <input type="text" value="{{ old('idnumber', $client->deliveryboy->idnumber) }}" class="form-control" id="idnumber" name="idnumber" placeholder="{{ trans('form.registration.investigator.id_number') }}">
                                                                @error('idnumber')
                                                                <span class="invalid-feedback" role="alert">
                                                                <strong>{{ $message }}</strong>
                                                                </span>
                                                            ...
                                                            <div class="form-group col-md-4">
                                                                ...
                                                                <input type="text" value="{{ old('idnumber', $client->deliveryboy->website) }}" class="form-control" id="website" name="website" placeholder="{{ trans('form.registration.client.website') }}">
                                                                @error('website')
                                                                <span class="invalid-feedback" role="alert">
                                                                <strong>{{ $message }}</strong>
                                                                </span>
                                                        ...
                                                        <div class="form-row">
                                                            ...
                                                            <div class="form-group col-md-6">
                                                                ...
                                                                <select multiple="multiple" class="select2 form-control select2-multiple input_required_s2" id="deliveryarea_id" name="deliveryarea_id[]" data-placeholder="{{ trans('form.registration.deliveryboy.delivery_helper') }}">
                                                                    @foreach($deliveryareas as $id => $deliveryarea)
                                                                        <option value="{{ $deliveryarea['id'] }}" {{ old('deliveryarea_id', in_array($id, $areas)) == $deliveryarea['id'] ? 'selected' : '' }}>
                                                            ...
                                                            <div class="form-group col-md-6">
                                                                ...
                                                                <div class="input-group">
                                                                    <input type="text" class="form-control" placeholder="{{trans('general.date_format')}}" id="dob" name="dob" value="{{ old('dob', date('d/m/Y', strtotime($client->deliveryboy->dob))) }}">
                                                                                                ...
                                                                                                <div class="form-row">
                                                                                                    ...
                                                                                                    <div class="form-group col-md-4">
                                                                                                        ...
                                                                                                        <select id="arr_address_type_{{$addrIndx}}" onchange="changeotheroldtextbox(this);changesubjecttitlebyid(this.id);" name="address[{{$addrIndx}}][address_type]"
                                                                                                                class="form-control arr_address_type multiple_input_required_s2 multiple_type_required_s2" required>
                                                                            ...
                                                                            <div id="phone_collapse-{{$phoneIndx}}"
                                                                                ...
                                                                                <div class="card-body">
                                                                                        ...
                                                                                        <div class="form-row">
                                                                                            ...
                                                                                            <div id="arr_otherphone_type_{{$phoneIndx}}_div" class="form-group col-md-4 arr_otherphone_other_text_div {{ ($seloth==0 || ($phone->phone_type == 'Other' || $email->email_type == 'Contact')) ? 'd-block' : 'd-none' }} ">
                                                                                                <label>{{ trans('form.registration.client.type') }}</label>
										...
										<!-- end Block for multiple fax-->
                                                        ...
                                                        <div class="form-row">
                                                            <div class="form-group col-md-12">
                                                                ...
                                                                <input value="{{ old('bank_number', !is_null($client->deliveryboy->deliveryboyBankDetail)?$client->deliveryboy->deliveryboyBankDetail->company:'') }}" type="text" class="form-control  @error('company') is-invalid @enderror" name="company" id="company" placeholder="{{ trans('form.registration.investigator.company') }}">
                                                                @error('company')
                                                                <span class="invalid-feedback" role="alert">
                                                                    <strong>{{ $message }}</strong>
                                                                </span>
                                                        ...
                                                        <div class="form-row">
                                                            <div class="form-group col-md-6">
                                                                ...
                                                                <input value="{{ old('name_of_bank', !is_null($client->deliveryboy->deliveryboyBankDetail)?$client->deliveryboy->deliveryboyBankDetail->name:'') }}" type="text" class="form-control  @error('name_of_bank') is-invalid @enderror" name="name_of_bank" id="name_of_bank" placeholder="{{ trans('form.registration.investigator.name_of_bank') }}">
                                                            ...
                                                            <div class="form-group col-md-6">
                                                                ...
                                                                <input type="text"
                                                                       value="{{ old('bank_number', !is_null($client->deliveryboy->deliveryboyBankDetail)?$client->deliveryboy->deliveryboyBankDetail->number:'') }}"
                                                        ...
                                                        <div class="form-row">
                                                            <div class="form-group col-md-4">
                                                                ...
                                                                <input value="{{ old('branch_name',!is_null($client->deliveryboy->deliveryboyBankDetail)?$client->deliveryboy->deliveryboyBankDetail->branch_name:'') }}" type="text" class="form-control @error('branch_name') is-invalid @enderror" name="branch_name" id="branch_name" placeholder="{{ trans('form.registration.investigator.branch_name') }}">
                                                                @error('branch_name')
                                                                <span class="invalid-feedback" role="alert">
                                                                    <strong>{{ $message }}</strong>
                                                                </span>
                                                            ...
                                                            <div class="form-group col-md-4">
                                                                ...
                                                                <input value="{{ old('branch_no', !is_null($client->deliveryboy->deliveryboyBankDetail)?$client->deliveryboy->deliveryboyBankDetail->branch_number:'') }}" type="text" class="form-control  @error('branch_no') is-invalid @enderror" name="branch_no" id="branch_no" placeholder="{{ trans('form.registration.investigator.branch_no') }}">
                                                                @error('branch_no')
                                                                <span class="invalid-feedback" role="alert">
                                                                    <strong>{{ $message }}</strong>
                                                                </span>
                                                            ...
                                                            <div class="form-group col-md-4">
                                                                ...
                                                                <input value="{{ old('account_no', !is_null($client->deliveryboy->deliveryboyBankDetail)?$client->deliveryboy->deliveryboyBankDetail->account_no:'') }}" type="text" class="form-control  @error('account_no') is-invalid @enderror" name="account_no" id="account_no" placeholder="{{ trans('form.registration.investigator.account_no') }}">
                                                                @error('account_no')
                                                                <span class="invalid-feedback" role="alert">
                                                                    <strong>{{ $message }}</strong>
                                                                </span>
