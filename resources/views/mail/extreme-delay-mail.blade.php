				...
				<div class="col-md-8 col-lg-6 col-xl-5">
					<div class="card overflow-hidden">
						<div class="card-body pt-0">
							...
							<div class="p-3">
								<p class="text-muted text-center">{{ trans('general.dear') }} {{ $user['name'] ?? '' }}</p>
								<p class="text-muted text-center">
                                    {{$type ?? ''}} {{$number ?? ''}} {{trans('content.email.delay_text')}} {{trans('general.by')}} {{$days ?? ''}} {{trans('content.email.days')}} 
                                </p>
                                <p class="text-muted text-center">
									{{trans('content.email.please_fix_text')}}
                                </p>
							</div>
							<br/>
							<p class="text-muted text-center">
