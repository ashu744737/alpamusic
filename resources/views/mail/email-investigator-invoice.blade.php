                ...
                <div class="col-md-8 col-lg-6 col-xl-5">
                    <div class="card overflow-hidden">
                        <div class="card-body pt-0">
                            ...
                            <div class="p-3">
                                <h4 class="text-muted font-size-18 mb-1 text-center">{{ trans('form.registration.verifymail.profile_update_text') }} {{ $investigator['user']['name'] ?? '' }}, {{ trans('content.email.invoice_ready') }}</h4>
                            </div>
                            <br/>
