            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        ...
                        <form name="investigation-form" id="investigation-form" class="form-horizontal mt-4" method="POST" action="{{ route('investigation.store') }}">
                                                ...
                                                <div id="next_step1">
                                                    <div class="form-row">
                                                        ...
                                                        @else
                                                            <div class="form-group col-md-6">
                                                                <label for="userinquiry">{{ trans('form.registration.investigation.user_inquiry') }} <span class="text-danger">*</span></label>
                                                                <input type="text" class="form-control " name="user_inquiry" value="{{Auth::user()->name}}"
                                                                    required id="userinquiry" placeholder="{{ trans('form.registration.investigation.user_inquiry') }}">
                                                            </div>
                                                        @endif

                                                        <div class="form-group col-md-6">
                                                            <label for="paying_customer">{{ trans('form.registration.investigation.paying_customer') }} <span class="text-danger">*</span></label>
                                                        ...
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            <input type="text" name="claim_number" class="form-control"
                                                                value="" id="claimNum" placeholder="{{ trans('form.registration.investigation.claim_number') }}">
                                                        </div>
                                                        ...
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            @if(isClient())
                                                            <input type="hidden" value="{{(!empty($products))?$products[0]->price:''}}" name="inv_cost" id="inv_cost">
                                                            @else
                                                            <input type="hidden" value="" name="inv_cost" id="inv_cost">
                                                            @endif
                                                            <input type="hidden" name="product_isdel" id="product_isdel"
                                                                   value="{{ isClient() ? ( !empty($products) ? ($products[0]->product->is_delivery == 1 ? 'yes' : 'no') : 'no' ) : '' }}">
                                                            <input type="hidden" name="product_delcost" id="product_delcost"
                                                                   value="{{ isClient() ? ( !empty($products) ? ($products[0]->product->delivery_cost != null ? $products[0]->product->delivery_cost : 0) : 0 ) : '' }}">
                                                            <input type="hidden" name="product_spousecost" id="product_spousecost"
                                                                   value="{{ isClient() ? ( !empty($products) ? ($products[0]->product->spouse_cost != null ? $products[0]->product->spouse_cost : 0) : 0 ) : '' }}">
                                                        </div>
                                                        ...
                                                        <div class="form-row">
                                                            ...
                                                            <div class="col-md-10">
                                                                <div class="pt-3 custom-control custom-checkbox">
                                                                    ...
                                                                    <label class="custom-control-label" for="approval_text" style="display: block">{{ trans('form.investigation.approval_text') }}</label>
                                                                </div>
                                                            </div>
    ...
    <div id="contact_collapse"
        ...
        <div class="card-body">
            ...
            <div class="form-row">
                ...
                <div class="form-group {{($acflag)?'col-md-4 d-non4':'col-md-4'}}">
                ...
                <div class="form-group {{($acflag)?'col-md-4':'col-md-4'}}">
                    <label for="additionalDetails">{{ trans('form.registration.investigation.passport') }}</label>
                ...
                <div class="form-group {{($acflag)?'col-md-4':'col-md-4'}}">
                    <label for="additionalDetails">{{ trans('form.registration.investigator.date_of_birth') }}</label>
                    <div class="input-group">
                        <input type="text" name="subjects[]['dob']" value="" 
                                class="form-control arr_contacts_dob datepicker" autofocus
                                placeholder="{{ trans('form.registration.investigator.date_of_birth') }}" readonly="">
                ...
                <div class="form-group col-md-4">
                    ...
                    <select onchange="changeothertextbox(this);changesubjecttitlebyid(this.id);" name="subjects[][sub_type]" class="form-control arr_contacts_subType multiple_type_required_s2" required data-id="">
                        @foreach($subtypes as $type)
                            <option value="{{ $type['name'] }}" {{ old('sub_type') == $type['name'] ? 'selected' : '' }}>{{ App::isLocale('hr')?$type['hr_name']:$type['name'] }}</option>
                        @endforeach
                    </select>
                </div>
        ...
        <div class="card-body">
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-4">
                    ...
                    <input type="text" value="" class="form-control multiple_input_required_s2 arr_address_type multiple_type_required_s2" name="subjects[]['address'][]['address_type']" placeholder="{{ trans('form.registration.client.address_type') }}" required>
...
<script>
    $(document).ready(function () {
        ...
        $('#investigation-form').on('submit', function (e) {
            ...
            if(!status){
                Swal.fire("{{trans('general.error_text')}}","{{trans('general.cannot_add_new_subject')}}", "error");
                return;
            }
