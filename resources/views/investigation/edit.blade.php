...
@section('title') {{ trans('form.registration.investigation.edit_investigation_title') }} @endsection
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        <h4 class="card-title">{{ trans('form.registration.investigation.edit_investigation_title') }}<span id="client_credit"></span></h4>
                        <p class="card-title-desc">{{ trans('form.registration.investigation.edit_investigation_desc') }}</p>
                    </div>

                    <div class="col-12">
                        
                        <form name="investigation-form" id="investigation-form" class="form-horizontal mt-4" method="POST" action="{{ route('investigation.update', [$invn->id]) }}">

                            @csrf
                            @method('PUT')

                            <input type="hidden" name="user_id" value="{{ $invn->user_id }}" id="user_id">
                                                    ...
                                                    <div class="form-row">
                                                        ...
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            <input type="text" name="work_order_number" class="form-control"
                                                                   value="{{$invn->work_order_number}}" id="orderNum" readonly>
                                                        </div>
                                                                                        ...
                                                                                        <div class="row"
                                                                                            ...
                                                                                            <div class="col-sm-12 col-md-6 text-left">
                                                                                                <h6 class="m-0 font-size-14">
                                                                                                    ...
                                                                                                    {{ trans('form.registration.investigation.subject') }} : <span id="arr_contacts_type_{{$subIndx}}_title" class="contact_row_no">
                                                                                                        @if(in_array($subject->sub_type, array('Main', 'Spouse', 'Company')))
                                                                                                            @if(config('app.locale') == 'hr')
                                                                                                            {{ \App\SubjectTypes::where('name', $subject->sub_type)->first()->hr_name }}
                                                                                                            @else
                                                                                                            {{ \App\SubjectTypes::where('name', $subject->sub_type)->first()->name }}
                                                                                                            @endif
                                                                                                        @else
                                                                                                            {{ $subject->sub_type }}
                                                                                                        @endif
                                                                                                    ...
                                                                                                    <label class="mt-2 ml-1 arr_contacts_address_confirmed_lable" for="address_confirmed_{{$subIndx}}" data-on-label="{{trans('general.yes')}}" data-off-label="{{trans('general.no')}}"></label>
                                                                                                    </div>
                                                                                                </h6>
                                                                                            </div>
                                                                                        ...
                                                                                        <div class="card-body">
                                                                                            ...
                                                                                            <div class="form-row">
                                                                                                <div class="form-group {{($acflag)?'col-md-4':'col-md-4'}}">
                                                                                                    ...
                                                                                                    <input type="number" onkeypress="settheSubjectId(this)" name="subjects[{{$subIndx}}][spouse]" 
                                                                                                           id="subjects_spouses_id_{{$subIndx}}" value="{{ $subject->spouse }}"
                                                                                                ...
                                                                                                <div class="form-group {{($acflag)?'col-md-4 d-none':'col-md-4'}}">
                                                                                                    ...
                                                                                                    <input type="number" name="subjects[{{$subIndx}}][req_inv_cost]" value="{{ $subject->req_inv_cost }}"
                                                                                                           ...
                                                                                                           placeholder="{{ trans('form.registration.investigation.required_cost_invs') }}" id="invcost_{{$subIndx}}"
                                                                                                    readonly>
                                                                                                </div>
                                                                                                <div class="form-group {{($acflag)?'col-md-4':'col-md-4'}}">
                                                                                                    <label for="passport">{{ trans('form.registration.investigation.passport') }}</label>
                                                                                                    <input type="number" onkeypress="settheSubjectId(this)" name="subjects[{{$subIndx}}][passport]" value="{{ $subject->passport }}"
                                                                                                ...
                                                                                                <div class="form-group {{($acflag)?'col-md-4':'col-md-4'}}">
                                                                                                    <label for="passport">{{ trans('form.registration.investigator.date_of_birth') }}</label>
                                                                                            ...
                                                                                            <div class="form-row">
                                                                                                ...
                                                                                                <div class="form-group col-md-4">
                                                                                                    ...
                                                                                                    <select onchange="changeotheroldtextbox(this);changesubjecttitlebyid(this.id);" name="subjects[{{$subIndx}}][sub_type]" id="arr_contacts_type_{{$subIndx}}" class="form-control arr_contacts_subType multiple_type_required_s2" data-id="{{$subIndx}}">
                                                                                                                                            ...
                                                                                                                                            <h6 class="m-0 font-size-14">
                                                                                                                                                <a href="#address_collapse-{{$subIndx.'-'.$addrIndx}}"
                                                                                                                                                   ...
                                                                                                                                                   aria-controls="collapse_1">
                                                                                                                                                    {{ trans('form.address') }} : <span id="arr_address_type_{{$subIndx.'-'.$addrIndx}}_title" class="address_row_no">
                                                                                                                                    ...
                                                                                                                                    <div class="card-body">
                                                                                                                                        ...
                                                                                                                                        <div class="form-row">
                                                                                                                                            ...
                                                                                                                                            <div class="form-group col-md-4">
                                                                                                                                                ...
                                                                                                                                                <input type="text" id="arr_address_type_{{$subIndx.'-'.$addrIndx}}" value="{{$address->address_type??''}}" class="form-control multiple_input_required_s2 arr_address_type multiple_type_required_s2" name="subjects[{{$subIndx}}][address][{{$addrIndx}}][address_type]" placeholder="{{ trans('form.registration.client.address_type') }}" required>
                                                                                                                                            ...
                                                                                                                                            <label class="address_other_no d-none">{{ trans('form.registration.client.type') }}</label>
        ...
        <div class="row"
            ...
            <div class="col-sm-12 col-md-6 text-left">
                <h6 class="m-0 font-size-14">
                    ...
                    <label class="mt-2 ml-1 arr_contacts_address_confirmed_lable" data-on-label="{{trans('general.yes')}}" data-off-label="{{trans('general.no')}}"></label>
                    </div>
                </h6>
            </div>
            <div class="col-sm-12 col-md-6 text-sm-right">
    ...
    <div id="address_collapse"
        ...
        <div class="card-body">
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-4">
                    <label>{{ trans('form.registration.client.address_type') }}</label>
                    <input type="text" class="form-control multiple_input_required_s2 arr_address_type multiple_type_required_s2" name="subjects[]['address'][]['address_type']" placeholder="{{ trans('form.registration.client.address_type') }}" required>
                    ...
                    if(isIdNull){
                        Swal.fire({
                            ...
                            if(result.value){
                                ...
                                var url = '/investigations/' + '{{ $invn->id }}';
                                    ...
                                    success: function (response) {
                                        if (response.status == 'success') {
                                            Swal.fire({
                                                ...
                                                text: (response.message) ? response.message : "{{trans('form.registration.investigation.investigation_updated')}}", 
                                                type: "success",
                                                confirmButtonText: "{{ trans('general.ok') }}",
                                            })
                                                .then((result) => {
                                            ...
                                            $('.create-btn').text("{{trans('general.update')}}");
                                        }
                                    },
