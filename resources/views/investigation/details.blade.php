            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-sm-8 col-xs-12 text-left text-sm-right mb-2">
                        <a href="javascript:void(0);" data-toggle="modal" data-target="#assignInvestigatorModal" class="btn btn-primary w-md waves-effect waves-light add-new-btn">{{ trans('form.investigation.assign_investigator') }}</a>
                    </div>
                </div>
...
<!-- Assign  -->
<div class="modal fade bd-example-modal-lg" id="assignInvestigatorModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">{{ trans('form.investigation.assign_investigator') }} </h5>
        ...
        <div class="form-row">
            <div class="col-md-12 form-group mb-3">
                <div class="input-group mb-3">
                  ...
                  <input type="text" class="form-control" id="search" name="search" placeholder="Search Investigator" value="{{ old('search') }}" aria-label="Username" aria-describedby="basic-addon1" style="height: 40px;" />
                </div>
                @error('search')
            ...
            <div class="col-md-12 form-group mb-3" id="investigator_list">
...
<script>
    $(document).ready(function () {
        ...
        let html = `<div class="form-row investigator-wrapper">
                                <p>Please search investigator.</p>
                            </div>
                            `;
        //$('#investigator_list').css('height','50px');
        //$('#investigator_list').css('min-height', '50px');
        $('#investigator_list').html(html)
        $('#search').on('keyup', function(){
            console.log($('#search').val(),'jhbhb')
            if($('#search').val()!=''){
                let html = `<div class="form-row investigator-wrapper">
                    <div class="col-md-5 details-wrapper">
                        <p class="name">Nirav Panchani</p>
                        <p><b>ID Number, </b>146</p>
                    </div>
                    <div class="col-md-4 phone_email">
                        <p>nirav.p@crestinfosystems.net</p>
                        <p>9974617666</p>
                    </div>
                ...
                <div class="form-row investigator-wrapper">
                    <div class="col-md-5 details-wrapper">
                        <p class="name">Nirav Panchani</p>
                        <p><b>ID Number, </b>146</p>
                    </div>
                ...
                </div><div class="form-row investigator-wrapper">
                    <div class="col-md-5 details-wrapper">
                        <p class="name">Nirav Panchani</p>
                        <p><b>ID Number, </b>146</p>
                    </div>
                ...
                //$('#investigator_list').css('height','300px');
                //$('#investigator_list').css('min-height', '300px');
                $('#investigator_list').html(html)
            } else {
                //$('#investigator_list').css('height','50px');
                //$('#investigator_list').css('min-height', '50px');
