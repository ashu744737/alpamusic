                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            ...
                            <form name="title-form" id="title-form" class="form-horizontal mt-4" method="POST" action="{{ route('title.update', $client->id) }}" onSubmit="return dosubmit();" >
                                                    ...
                                                    <div id="next_step1">
                                                        ...
                                                        <div class="form-row">
                                                            ...
                                                            <div class="form-group col-md-6">
                                                                ...
                                                                <input type="text" name="name" value="{{ old('name', $title->name) }}" required autocomplete="name" class="form-control @error('name') is-invalid @enderror" autofocus id="name" placeholder="Enter the Name">
                                                                @error('name')
                                                            ...
                                                            <div class="form-group col-md-6">
                                                                ...
                                                                <select multiple="multiple" class="select2 form-control select2-multiple input_required_s2" id="specializations" name="categories[]" data-placeholder="Select Category">
                                                                    @foreach($categories as $id => $categories)
                                                                        <option value="{{ $categories['id'] }}" {{ old('categories', in_array($categories['id'], $cats)) == $categories['id'] ? 'selected' : '' }}>
                                                                        {{ $categories['name'] }}
                                                                        </option>
                                                                    @endforeach
                                                                </select>
                                                    ...
                                                    <div id="next_step2">
                                                        ...
                                                        <div class="form-row">
                                                            <div class="form-group col-md-6">
                                                                ...
                                                                <input type="email" name="owner_mail" value="{{ old('owner_mail', $title_owner->email) }}" autocomplete="owner_mail" class="form-control @error('owner_mail') is-invalid @enderror" autofocus id="owner_mail" placeholder="Enter Owner Email">
                                                                @error('owner_mail')
                                                                <span class="invalid-feedback" role="alert">
                                                                    <strong>{{ $message }}</strong>
                                                                </span>
