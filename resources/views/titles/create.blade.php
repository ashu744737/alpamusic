...
{{-- @section('title') {{trans('form.registration.investigator.create_investigator_title')}} @endsection --}}
    ...
    <div class="col-sm-6">
        <div class="page-title-box">
            <ol class="breadcrumb m-0">
                <li class="breadcrumb-item"><a href="{{route('titles')}}">{{ trans('form.titles') }}</a></li>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            {{-- <h4 class="card-title">{{trans('form.registration.investigator.create_investigator_title')}}</h4> --}}
                            <h4 class="card-title">Create New Title</h4>
                           
                            {{-- <p class="card-title-desc">{{trans('form.registration.investigator.create_investigator_desc')}}</p> --}}
                        ...
                        <div class="col-12">
                            ...
                            <form name="title-form" id="title-form" class="form-horizontal mt-4" method="POST" action="{{ route('titles.store') }}" onSubmit="return dosubmit();" enctype="multipart/form-data" >
                                @csrf
                                <input type="hidden" name="user_id" value="{{$typeid}}">
                                    ...
                                    <ul class="nav">
                                        <li class="nav-item">
                                            <a class="nav-link" href="#step-1">
                                                ...
                                                <strong>{{ trans('form.step_1') }}</strong> <br>Title Details
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="#step-2">
                                                ...
                                                <strong>{{ trans('form.step_2') }}</strong> <br>Contributor Details
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="#step-3">
                                                {{-- <strong>{{ trans('form.step_3') }}</strong> <br>{{ trans('form.registration.client.contact_details') }} --}}
                                                <strong>{{ trans('form.step_3') }}</strong> <br>Create Title
                                                    ...
                                                    <div id="next_step1">
                                                        ...
                                                        <div class="form-row">
                                                            ...
                                                            <div class="form-group col-md-6">
                                                                ...
                                                                <input type="text" name="name" value="{{ old('name') }}" autocomplete="name" class="form-control @error('name') is-invalid @enderror" autofocus id="name" placeholder="Enter the Name">
                                                                @error('name')
                                                            ...
                                                            <div class="form-group col-md-6">
                                                                ...
                                                                <select multiple="multiple" class="select2 form-control select2-multiple input_required_s2 @error('categories') is-invalid @enderror" id="specializations" name="categories[]" data-placeholder="Select Category">
                                                                   
                                                                    @foreach($categories as $id => $categories)
                                                                        <option value="{{ $categories['id'] }}" {{ old('categories') == $categories['id'] ? 'selected' : '' }}>
                                                                            {{ App::isLocale('hr')?$categories['hr_name']:$categories['name'] }}
                                                                        </option>
                                                                    @endforeach
                                                                </select>
                                                                @error('categories')
                                                        ...
                                                        <div class="form-row">
                                                            ...
                                                            <div class="form-group col-md-6">
                                                                <input type="file" class="@error('file_path') is-invalid @enderror" name="file_path[]" id="file_path" placeholder="Select the files" multiple>
                                                                @error('file_path')
                                                                <span class="invalid-feedback" role="alert">
                                                                    <strong>{{ $message }}</strong>
                                                                </span>
                                                    ...
                                                    <div id="next_step2">
                                                        ...
                                                        {{-- <div class="form-row">
                                                            <div class="form-group col-md-6">
                                                                ...
                                                                <input type="email" name="owner_mail" value="{{ old('owner_mail') }}" autocomplete="owner_mail" class="form-control @error('owner_mail') is-invalid @enderror" autofocus id="owner_mail" placeholder="Enter Owner Email">
                                                                @error('owner_mail')
                                                                <span class="invalid-feedback" role="alert">
                                                                    <strong>{{ $message }}</strong>
                                                                </span>
                                                            ...
                                                            <div class="form-group col-md-6">
                                                                ...
                                                                <select name="types[]" id="types" multiple class="select2 form-control select2-multiple input_required_s2"> 
                                                            ...
                                                            <div class="form-group col-md-6">
                                                                ...
                                                                <input type="text" name="first_name" value="{{ old('first_name') }}" autocomplete="first_name" class="form-control @error('first_name') is-invalid @enderror" autofocus id="first_name" placeholder="Enter First Name">
                                                                @error('first_name')
                                                                <span class="invalid-feedback" role="alert">
                                                                    <strong>{{ $message }}</strong>
                                                                </span>
                                                            ...
                                                            <div class="form-group col-md-6">
                                                                ...
                                                                <input type="text" name="last_name" value="{{ old('last_name') }}" autocomplete="last_name" class="form-control @error('last_name') is-invalid @enderror" autofocus id="last_name" placeholder="Enter Last Name">
                                                                @error('last_name')
                                                                <span class="invalid-feedback" role="alert">
                                                                    <strong>{{ $message }}</strong>
                                                                </span>
                                                            ...
                                                            <div class="table-responsive mb-0 fixed-solution"
                                                                ...
                                                                <div id="contributores_tbl">
                                                                    <table class="table table-borderless mb-0">
                                                                        ...
                                                                        <tr>
                                                                            {{-- <th class="btn-primary"><h4
                                                                                        class="font-size-18 mb-1">{{ trans('form.registration.client.contributor_details') }}</h4>
                                                                            </th> --}}
                                                                            <th class="btn-primary"><h4
                ...
                <div class="col-sm-12 col-md-6 text-left">
                    <h6 class="m-0 font-size-14">
                        <a href="#contributor_collapse"
                           ...
                           {{-- Contributor Details : <span class="contributor_row_no"></span> --}}
                           Contributor Details :
                        </a>
                    </h6>
                </div>
            ...
            if (step == 'step1') {
                ...
                if ($("#title-form").valid() === true) {
                    ...
                    if ($(".owner-base-row").length < 1) {
                        $("#owner_footer").html('<span class="error">{{ trans('general.minimum_entry') }}</span>');
                    ...
                    if ($(".contributor-base-row").length < 1) {
                        $("#contributor_footer").html('<span class="error">{{ trans('general.minimum_entry') }}</span>');
