<?php $__env->startSection('title'); ?> Edit Title <?php $__env->stopSection(); ?>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <h4 class="card-title">Edit Title Details</h4>
                            <p class="card-title-desc">You can edit Title details from here.</p>
                        </div>

                        <div class="col-12">

                            <form name="title-form" id="title-form" class="form-horizontal mt-4" method="POST" action="<?php echo e(route('title.update', $client->id)); ?>" onSubmit="return dosubmit();" >
                                                    ...
                                                    <div id="next_step1">
                                                        ...
                                                        <div class="form-row">
                                                            ...
                                                            <div class="form-group col-md-6">
                                                                ...
                                                                <input type="text" name="name" value="<?php echo e(old('name', $title->name)); ?>" required autocomplete="name" class="form-control <?php $__errorArgs = ['name'];
...
unset($__errorArgs, $__bag); ?>
                                                            ...
                                                            <div class="form-group col-md-6">
                                                                ...
                                                                <select multiple="multiple" class="select2 form-control select2-multiple input_required_s2" id="specializations" name="categories[]" data-placeholder="Select Category">
                                                                    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $categories): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                        <option value="<?php echo e($categories['id']); ?>" <?php echo e(old('categories', in_array($categories['id'], $cats)) == $categories['id'] ? 'selected' : ''); ?>>
                                            ...
                                            <div class="row">
                                                <div class="col-12 p-4">
                                                    ...
                                                    <div id="next_step2">
                                                        ...
                                                        <div class="form-row">
                                                            <div class="col-md-12">
                                                                <h4 class="text-muted font-size-18 mb-1">Owner Details</h4>
                                                                <hr>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-row">
                                                            <div class="form-group col-md-6">
                                                                ...
                                                                <input type="email" name="owner_mail" value="<?php echo e(old('owner_mail', $title_owner->email)); ?>" autocomplete="owner_mail" class="form-control <?php $__errorArgs = ['owner_mail'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" autofocus id="owner_mail" placeholder="Enter Owner Email">
                                                                <?php $__errorArgs = ['owner_mail'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                                                            ...
                                                            <div class="table-responsive mb-0 fixed-solution"
                                                                ...
                                                                <div id="addresses_tbl">
                                                                    <table class="table table-borderless mb-0">
                                                                        <thead>
                                                                        <tr>
                                                                            <th class="btn-primary"><h4 class="font-size-18 mb-1">Contributors</h4>
                                                                            </th>
                                                                        </tr>
                                                                        </thead>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/uvda/resources/views/titles/edit.blade.php ENDPATH**/ ?>