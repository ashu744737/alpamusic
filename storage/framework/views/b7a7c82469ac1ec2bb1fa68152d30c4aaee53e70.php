<?php $__env->startSection('title'); ?> <?php echo e(trans('form.registration.investigation.edit_investigation_title')); ?> <?php $__env->stopSection(); ?>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        <h4 class="card-title"><?php echo e(trans('form.registration.investigation.edit_investigation_title')); ?><span id="client_credit"></span></h4>
                        <p class="card-title-desc"><?php echo e(trans('form.registration.investigation.edit_investigation_desc')); ?></p>
                    </div>

                    <div class="col-12">
                        
                        <form name="investigation-form" id="investigation-form" class="form-horizontal mt-4" method="POST" action="<?php echo e(route('investigation.update', [$invn->id])); ?>">

                            <?php echo csrf_field(); ?>
                            <?php echo method_field('PUT'); ?>

                            <input type="hidden" name="user_id" value="<?php echo e($invn->user_id); ?>" id="user_id">
                                                ...
                                                <div id="next_step1">
                                                    <div class="form-row">
                                                            ...
                                                            <div class="form-group col-md-6">
                                                                ...
                                                                <select name="user_inquiry" id="userinquiry" class="form-control userinquiry_dd" required>
                                                                    ...
                                                                    <?php $__currentLoopData = $clients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                        <option value="<?php echo e($key.'-'.$value); ?>" <?php echo e($key.'-'.$value == old('user_inquiry', $invn->user_id.'-'.$invn->user_inquiry) ? 'selected' : ''); ?>><?php echo e($value); ?></option>
                                                        ...
                                                        <?php else: ?>
                                                            <div class="form-group col-md-6">
                                                                <label for="userinquiry"><?php echo e(trans('form.registration.investigation.user_inquiry')); ?> <span class="text-danger">*</span></label>
                                                                <input type="text" class="form-control " name="user_inquiry" value="<?php echo e(old('user_inquiry', $invn->user_inquiry)); ?>"
                                                                    required id="userinquiry" placeholder="<?php echo e(trans('form.registration.investigation.user_inquiry')); ?>">
                                                            </div>
                                                        <?php endif; ?>

                                                        <div class="form-group col-md-6">
                                                            <label for="paying_customer"><?php echo e(trans('form.registration.investigation.paying_customer')); ?> <span
                                                            ...
                                                            <select name="paying_customer" id="paying_customer" class="form-control paying_customer_dd" required>
                                                                ...
                                                                <?php $__currentLoopData = $customers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $customer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                    <option value="<?php echo e($customer->id); ?>" <?php echo e($customer->id == old('paying_customer', $invn->paying_customerid) ? 'selected' : ''); ?>
                                                        ...
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            <input type="text" name="ex_file_claim_no" value="<?php echo e(old('ex_file_claim_no', $invn->ex_file_claim_no)); ?>"
                                                        ...
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            <input type="text" name="claim_number" class="form-control"
                                                                value="<?php echo e(old('claim_number', $invn->claim_number)); ?>" id="claimNum" placeholder="<?php echo e(trans('form.registration.investigation.claim_number')); ?>">
                                                        </div>
                                                        ...
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            <input type="text" name="work_order_number" class="form-control"
                                                                   value="<?php echo e($invn->work_order_number); ?>" id="orderNum" readonly>
                                                        </div>
                                                        ...
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            <?php if(isClient()): ?>
                                                                <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                    <option value="<?php echo e($product->product->id); ?>" <?php echo e($product->product->id == old('type_of_inquiry', $invn->type_of_inquiry) ? 'selected' : ''); ?>
                                                        ...
                                                        <div class="form-group del-checks" style="display: none">
                                                            <div class="form-group col-md-12">
                                                                ...
                                                                <div class="custom-control custom-checkbox">
                                                                    <input type="checkbox" class="custom-control-input" id="personal_del" name="personal_del" value="1" <?php echo e($invn->personal_del == '1' ? 'checked' : ''); ?>>
                                                            ...
                                                            <div class="form-group col-md-12">
                                                                <div class="custom-control custom-checkbox">
                                                                    <input type="checkbox" class="custom-control-input" id="company_del" name="company_del" value="1" <?php echo e($invn->company_del == '1' ? 'checked' : ''); ?>>
                                                                    <label class="custom-control-label" for="company_del"><?php echo e(trans('form.registration.investigation.company_del')); ?></label>
                                                                </div>
                                                            </div>

                                                            <div class="form-group col-md-12 company-del-checks" style="<?php echo e($invn->company_del != '1' ? 'display: none' : ''); ?>">
                                                                <div class="custom-control custom-checkbox mb-2">
                                                                    <input type="checkbox" class="custom-control-input" id="make_paste" name="make_paste" value="1" <?php echo e($invn->make_paste == '1' ? 'checked' : ''); ?>>
                                                                    <label class="custom-control-label" for="make_paste"><?php echo e(trans('form.registration.investigation.make_paste')); ?></label>
                                                                </div>
                                                                <div class="custom-control custom-checkbox">
                                                                    <input type="checkbox" class="custom-control-input" id="deliver_by_manager" name="deliver_by_manager" value="1" <?php echo e($invn->deliver_by_manager == '1' ? 'checked' : ''); ?>>
                                                        ...
                                                        <div class="table-responsive mb-0 fixed-solution" data-pattern="priority-columns">
                                                            <div id="contacts_tbl">
                                                                <table class="table table-borderless mb-0">
                                                                    ...
                                                                    <?php $__currentLoopData = $invn->subjects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subject): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                        <tr class="contact-base-row" style="display: block;">
                                                                            <td style="width: 100%;display: inline-table;">
                                                                                <div class="card mb-1 shadow-none" id="contact_clone_element-<?php echo e($subIndx); ?>">
                                                                                        ...
                                                                                        <div class="row"
                                                                                            ...
                                                                                            <div class="col-sm-12 col-md-6 text-left">
                                                                                                <h6 class="m-0 font-size-14">
                                                                                                    <a href="#contact_collapse-<?php echo e($subIndx); ?>"
                                                                                                       class="text-dark collapsed contact_header"
                                                                                                       data-toggle="collapse"
                                                                                                       aria-expanded="true"
                                                                                                       aria-controls="contact_collapse">
                                                                                                    <?php echo e(trans('form.registration.investigation.subject')); ?> : <span id="arr_contacts_type_<?php echo e($subIndx); ?>_title" class="contact_row_no">
                                                                                                        <?php if(in_array($subject->sub_type, array('Main', 'Spouse', 'Company'))): ?>
                                                                                                            <?php if(config('app.locale') == 'hr'): ?>
                                                                                                            <?php echo e(\App\SubjectTypes::where('name', $subject->sub_type)->first()->hr_name); ?>

                                                                                                            <?php else: ?>
                                                                                                            <?php echo e(\App\SubjectTypes::where('name', $subject->sub_type)->first()->name); ?>

                                                                                                            <?php endif; ?>
                                                                                                        <?php else: ?>
                                                                                                            <?php echo e($subject->sub_type); ?>
                                                                                                    ...
                                                                                                    <input id="address_confirmed_<?php echo e($subIndx); ?>" name="subjects[<?php echo e($subIndx); ?>][address_confirmed]" class="arr_contacts_address_confirmed" type="checkbox" switch="bool" <?php echo e($subject->address_confirmed == 1 ? 'checked' : ''); ?>>
                                                                                                    <label class="mt-2 ml-1 arr_contacts_address_confirmed_lable" for="address_confirmed_<?php echo e($subIndx); ?>" data-on-label="<?php echo e(trans('general.yes')); ?>" data-off-label="<?php echo e(trans('general.no')); ?>"></label>
                                                                                                    </div>
                                                                                                </h6>
                                                                                            </div>
                                                                                    ...
                                                                                    <div id="contact_collapse-<?php echo e($subIndx); ?>"
                                                                                        ...
                                                                                        <div class="card-body">
                                                                                            ...
                                                                                            <div class="form-row">
                                                                                                <div class="form-group col-md-4">
                                                                                                    ...
                                                                                                    <input type="text" value="<?php echo e($subject->family_name); ?>"
                                                                                                           class="form-control arr_contacts_family input_required_s2"
                                                                                                           name="subjects[<?php echo e($subIndx); ?>][family_name]"
                                                                                                ...
                                                                                                <div class="form-group col-md-4">
                                                                                                    ...
                                                                                                    <input type="text" value="<?php echo e($subject->first_name); ?>"
                                                                                                           class="form-control arr_contacts_firstname input_required_s2"
                                                                                                           name="subjects[<?php echo e($subIndx); ?>][first_name]"
                                                                                                ...
                                                                                                <div class="form-group col-md-4">
                                                                                                    ...
                                                                                                    <input onkeypress="settheSubjectId(this)" id="subjects_id_<?php echo e($subIndx); ?>" type="number" maxwidth="9" value="<?php echo e($subject->id_number); ?>"
                                                                                                           class="form-control arr_contacts_id"
                                                                                                           name="subjects[<?php echo e($subIndx); ?>][id_number]"
                                                                                                           placeholder="<?php echo e(trans('form.registration.investigation.id')); ?>"
                                                                                                           data-im-insert="true"
                                                                                                           data-index="<?php echo e($subIndx); ?>" data-allow="">
                                                                                                           <label id="id-error-<?php echo e($subIndx); ?>" class="id_error error d-none" for="id-error"><?php echo e(trans('form.registration.investigation.id_error')); ?></label>
                                                                                                </div>
                                                                                            </div>
                                                                                            ...
                                                                                            <div class="form-row">
                                                                                                ...
                                                                                                <div class="form-group col-md-4">
                                                                                                    ...
                                                                                                    <input type="text" name="subjects[<?php echo e($subIndx); ?>][bank_account_no]" class="form-control arr_contacts_accNum"
                                                                                                           value="<?php echo e($subject->bank_account_no); ?>"
                                                                                                ...
                                                                                                <div class="form-group col-md-4">
                                                                                                    ...
                                                                                                    <input type="text" value="<?php echo e($subject->workplace); ?>"
                                                                                                           class="form-control arr_contacts_workplace"
                                                                                                           name="subjects[<?php echo e($subIndx); ?>][workplace]"
                                                                                                ...
                                                                                                <div class="form-group col-md-4">
                                                                                                    ...
                                                                                                    <input type="text" value="<?php echo e($subject->website); ?>"
                                                                                                           class="form-control arr_contacts_website"
                                                                                                           name="subjects[<?php echo e($subIndx); ?>][website]"
                                                                                            ...
                                                                                            <div class="form-row">
                                                                                                <div class="form-group col-md-4">
                                                                                                    ...
                                                                                                    <input type="text" name="subjects[<?php echo e($subIndx); ?>][father_name]" value="<?php echo e($subject->father_name); ?>"
                                                                                                ...
                                                                                                <div class="form-group col-md-4">
                                                                                                    ...
                                                                                                    <input type="text" name="subjects[<?php echo e($subIndx); ?>][mother_name]" value="<?php echo e($subject->mother_name); ?>"
                                                                                                ...
                                                                                                <div class="form-group col-md-4">
                                                                                                    ...
                                                                                                    <input type="text" name="subjects[<?php echo e($subIndx); ?>][spouse_name]" value="<?php echo e($subject->spouse_name); ?>"
                                                                                            ...
                                                                                            <div class="form-row">
                                                                                                <div class="form-group <?php echo e(($acflag)?'col-md-4':'col-md-4'); ?>">
                                                                                                    ...
                                                                                                    <input type="number" onkeypress="settheSubjectId(this)" name="subjects[<?php echo e($subIndx); ?>][spouse]" 
                                                                                                           id="subjects_spouses_id_<?php echo e($subIndx); ?>" value="<?php echo e($subject->spouse); ?>"
                                                                                                           class="form-control arr_contacts_spouses" autofocus
                                                                                                           data-im-insert="true" 
                                                                                                           placeholder="<?php echo e(trans('form.registration.investigation.spouse')); ?>" 
                                                                                                           data-index="<?php echo e($subIndx); ?>" 
                                                                                                           data-allow="">
                                                                                                    <label id="id-spouses-error-<?php echo e($subIndx); ?>" class="id_spouses_error error d-none" for="id-spouses-error"><?php echo e(trans('form.registration.investigation.id_spouses_error')); ?></label>
                                                                                                </div>
                                                                                                <div class="form-group <?php echo e(($acflag)?'col-md-4':'col-md-4'); ?>">
                                                                                                    <label for="carNum"><?php echo e(trans('form.registration.investigation.carnumber')); ?></label>
                                                                                                    <input type="text" name="subjects[<?php echo e($subIndx); ?>][car_number]" value="<?php echo e($subject->car_number); ?>"
                                                                                                           class="form-control arr_contacts_carNum" autofocus
                                                                                                           placeholder="<?php echo e(trans('form.registration.investigation.carnumber')); ?>">
                                                                                                </div>
                                                                                                <div class="form-group <?php echo e(($acflag)?'col-md-4 d-none':'col-md-4'); ?>">
                                                                                                    <label for="invCost"><?php echo e(trans('form.registration.investigation.required_cost_invs')); ?>(<?php echo e(trans('general.money_symbol')); ?>) <span
                                                                                                                class="text-danger">*</span></label>
                                                                                                    <input type="number" name="subjects[<?php echo e($subIndx); ?>][req_inv_cost]" value="<?php echo e($subject->req_inv_cost); ?>"
                                                                                                           class="form-control input_required_s2 arr_contacts_invCost" autofocus required
                                                                                                           placeholder="<?php echo e(trans('form.registration.investigation.required_cost_invs')); ?>" id="invcost_<?php echo e($subIndx); ?>"
                                                                                                    readonly>
                                                                                                </div>
                                                                                                <div class="form-group <?php echo e(($acflag)?'col-md-4':'col-md-4'); ?>">
                                                                                                    <label for="passport"><?php echo e(trans('form.registration.investigation.passport')); ?></label>
                                                                                                    <input type="number" onkeypress="settheSubjectId(this)" name="subjects[<?php echo e($subIndx); ?>][passport]" value="<?php echo e($subject->passport); ?>"
                                                                                                            id="subjects_passport_id_<?php echo e($subIndx); ?>"
                                                                                                           class="form-control arr_contacts_passport" autofocus
                                                                                                           placeholder="<?php echo e(trans('form.registration.investigation.passport')); ?>"
                                                                                                           data-index="<?php echo e($subIndx); ?>" 
                                                                                                           data-allow="">
                                                                                                    <label id="id-passport-error-<?php echo e($subIndx); ?>" class="id_passport_error error d-none" for="id-passport-error"><?php echo e(trans('form.registration.investigation.id_passport_error')); ?></label>
                                                                                                </div>
                                                                                                <div class="form-group <?php echo e(($acflag)?'col-md-4':'col-md-4'); ?>">
                                                                                                    <label for="passport"><?php echo e(trans('form.registration.investigator.date_of_birth')); ?></label>
                                                                                                    <input type="date" name="subjects[<?php echo e($subIndx); ?>][dob]" value="<?php echo e($subject->dob); ?>"
                                                                                                           class="form-control arr_contacts_dob" autofocus
                                                                                                           placeholder="<?php echo e(trans('form.registration.investigator.date_of_birth')); ?>">
                                                                                                </div>
                                                                                            </div>
                                                                                            ...
                                                                                            <div class="form-row">
                                                                                                ...
                                                                                                <div class="form-group col-md-4">
                                                                                                    ...
                                                                                                    <input type="text" name="subjects[<?php echo e($subIndx); ?>][assistive_details]" value="<?php echo e($subject->assistive_details); ?>"
                                                                                                ...
                                                                                                <?php $seloth = 0; ?>
                                                                                                <?php $__currentLoopData = $subtypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $type_name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                                                    <?php if($type_name['name'] == $subject->sub_type): ?>
                                                                                                        <?php $seloth = 1; ?>
                                                                                                    <?php endif; ?>
                                                                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                                                <div class="form-group col-md-4">
                                                                                                    <label for="sub_type"><?php echo e(trans('form.registration.investigation.sub_type')); ?></label>
                                                                                                    <select onchange="changeotheroldtextbox(this);changesubjecttitlebyid(this.id);" name="subjects[<?php echo e($subIndx); ?>][sub_type]" id="arr_contacts_type_<?php echo e($subIndx); ?>" class="form-control arr_contacts_subType multiple_type_required_s2" data-id="<?php echo e($subIndx); ?>">
                                                                                                        <?php $__currentLoopData = $subtypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                                                            <option <?php echo e(((($type['name'] == 'Other' || $type['name'] == 'Contact') && $seloth==0) || ($type['name'] == $subject->sub_type)) ? 'selected' : ''); ?> value="<?php echo e($type['name']); ?>">
                                                                                                            <?php echo e(App::isLocale('hr')?$type['hr_name']:$type['name']); ?>

                                                                                                            </option>
                                                                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                                                    </select>
                                                                                                </div>
                                                                                                <div class="form-group col-md-4 arr_contacts_other_text_div <?php echo e(($seloth==0 || ($subject->sub_type == 'Other' || $subject->sub_type == 'Contact'))? 'd-block' : 'd-none'); ?>" id="arr_contacts_type_<?php echo e($subIndx); ?>_div">
                                                                                                    <label><?php echo e(trans('form.registration.client.type')); ?></label>
                                                                                
                                                                                                    <input type="text" id="arr_contacts_type_<?php echo e($subIndx); ?>_otext" data-id="arr_contacts_type_<?php echo e($subIndx); ?>" onchange="changeothersubjecttitle(this);" value="<?php echo e(($seloth==0) ? $subject->sub_type  : ''); ?>"
                                                                                                           class="form-control numeric arr_contacts_other_text_type"
                                                                                                           name="subjects[<?php echo e($subIndx); ?>][other_text]"
                                                                                            ...
                                                                                            <div class="form-row mt-3">
                                                                                                ...
                                                                                                <div class="form-row">
                                                                                                    <div class="form-group col-md-3">
                                                                                                        ...
                                                                                                        <input type="email" value="<?php echo e($subject->main_email); ?>" 
                                                                                                               class="form-control arr_contacts_mainemails"
                                                                                                               name="subjects[<?php echo e($subIndx); ?>][main_email]"
                                                                                                    ...
                                                                                                    <div class="form-group col-md-3">
                                                                                                        ...
                                                                                                        <input type="email" value="<?php echo e($subject->alternate_email); ?>"
                                                                                                               class="form-control arr_contacts_alternateemails"
                                                                                                               name="subjects[<?php echo e($subIndx); ?>][alternate_email]"
                                                                                                               placeholder="<?php echo e(trans('general.email_placeholder')); ?>"
                                                                                                        >
                                                                                                    </div>
                                                                                                    <div class="form-group col-md-3">
                                                                                                        <label><?php echo e(trans('form.registration.investigation.main_phone')); ?></label>
                                                                                                        <input type="tel" value="<?php echo e($subject->main_phone); ?>"
                                                                                                               class="form-control arr_contacts_mainphones " 
                                                                                                               name="subjects[<?php echo e($subIndx); ?>][main_phone]"
                                                                                                    ...
                                                                                                    <div class="form-group col-md-3">
                                                                                                        ...
                                                                                                        <input type="tel" value="<?php echo e($subject->secondary_phone); ?>"
                                                                                                               class="form-control arr_contacts_secondaryphones" 
                                                                                                               name="subjects[<?php echo e($subIndx); ?>][secondary_phone]"
                                                                                                               placeholder="<?php echo e(trans('general.phone_placeholder')); ?>"
                                                                                                              >
                                                                                                    </div>
                                                                                                </div>
                                                                                                <div class="form-row">
                                                                                                    <div class="form-group col-md-4">
                                                                                                        ...
                                                                                                        <input type="tel" value="<?php echo e($subject->main_mobile); ?>"
                                                                                                               class="form-control arr_contacts_mainmobiles" 
                                                                                                               name="subjects[<?php echo e($subIndx); ?>][main_mobile]"
                                                                                                               placeholder="<?php echo e(trans('general.phone_placeholder')); ?>"
                                                                                                                >
                                                                                                    </div>
                                                                                                    <div class="form-group col-md-4">
                                                                                                        <label><?php echo e(trans('form.registration.investigation.secondary_mobile')); ?></label>
                                                                                                        <input type="tel" value="<?php echo e($subject->secondary_mobile); ?>"
                                                                                                               class="form-control arr_contacts_secondarymobiles" 
                                                                                                               name="subjects[<?php echo e($subIndx); ?>][secondary_mobile]"
                                                                                                               placeholder="<?php echo e(trans('general.phone_placeholder')); ?>"
                                                                                                             >
                                                                                                    </div>
                                                                                                    <div class="form-group col-md-4">
                                                                                                        <label><?php echo e(trans('form.registration.investigation.fax')); ?> </label>
                                                                                                        <input type="tel" value="<?php echo e($subject->fax); ?>"
                                                                                                               class="form-control arr_contacts_fax" 
                                                                                                               name="subjects[<?php echo e($subIndx); ?>][fax]"
                                                                                                ...
                                                                                                <div class="table-wrapper">
                                                                                                    <div class="table-responsive mb-0 fixed-solution"
                                                                                                        ...
                                                                                                        <div id="addresses_tbl">
                                                                                                            <table class="table table-borderless mb-0">
                                                                                                                <tbody id="address-accordion-<?php echo e($subIndx); ?>" class="addresses_tbl_tbody">
                                                                                                                ...
                                                                                                                <?php $__currentLoopData = $subject->subject_addresses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $address): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                                                                    ...
                                                                                                                    <tr class="address-base-row-<?php echo e($subIndx); ?>">
                                                                                                                        <td style="width: 100%;display: inline-table;">
                                                                                                                            <div class="card mb-1 shadow-none" id="address_clone_element-<?php echo e($subIndx.'-'.$addrIndx); ?>">
                                                                                                                                <div class="card-header p-3" id="address_heading"
                                                                                                                                    ...
                                                                                                                                    <div class="row"
                                                                                                                                        ...
                                                                                                                                        <div class="col-sm-12 col-md-6 text-left">
                                                                                                                                            <h6 class="m-0 font-size-14">
                                                                                                                                                <a href="#address_collapse-<?php echo e($subIndx.'-'.$addrIndx); ?>"
                                                                                                                                                   class="text-dark collapsed address_header"
                                                                                                                                                   data-toggle="collapse"
                                                                                                                                                   aria-expanded="true"
                                                                                                                                                   aria-controls="collapse_1">
                                                                                                                                                    <?php echo e(trans('form.address')); ?> : <span id="arr_address_type_<?php echo e($subIndx.'-'.$addrIndx); ?>_title" class="address_row_no">
                                                                                                                                        ...
                                                                                                                                        <div class="col-sm-12 col-md-6 text-sm-right">
                                                                                                                                            <button type="button"
                                                                                                                                                    ...
                                                                                                                                                    style="text-decoration: underline" id="<?php echo e($subIndx); ?>">
                                                                                                                                                <?php echo e(trans('general.delete')); ?>
                                                                                                                                ...
                                                                                                                                <div id="address_collapse-<?php echo e($subIndx.'-'.$addrIndx); ?>"
                                                                                                                                    ...
                                                                                                                                    <div class="card-body">
                                                                                                                                        <div class="form-row">
                                                                                                                                            <div class="form-group col-md-6">
                                                                                                                                                ...
                                                                                                                                                <input type="text" value="<?php echo e($address->address1); ?>"
                                                                                                                                                       class="form-control pac-target-input multiple_input_required_s2 arr_address_address1"
                                                                                                                                                       name="subjects[<?php echo e($subIndx); ?>][address][<?php echo e($addrIndx); ?>][address1]"
                                                                                                                                                       id="address_complete_<?php echo e($subIndx.'-'.$addrIndx); ?>"
                                                                                                                                            ...
                                                                                                                                            <div class="form-group col-md-6">
                                                                                                                                                ...
                                                                                                                                                <input type="text" value="<?php echo e($address->address2); ?>"
                                                                                                                                                       class="form-control arr_address_address2"
                                                                                                                                                       name="subjects[<?php echo e($subIndx); ?>][address][<?php echo e($addrIndx); ?>][address2]"
                                                                                                                                                       id="address2_<?php echo e($subIndx.'-'.$addrIndx); ?>"
                                                                                                                                        ...
                                                                                                                                        <div class="form-row">
                                                                                                                                            <div class="form-group col-md-3">
                                                                                                                                                ...
                                                                                                                                                <input type="text" value="<?php echo e($address->city); ?>"
                                                                                                                                                       ...
                                                                                                                                                       name="subjects[<?php echo e($subIndx); ?>][address][<?php echo e($addrIndx); ?>][city]"
                                                                                                                                                       id="city_<?php echo e($subIndx.'-'.$addrIndx); ?>"
                                                                                                                                            ...
                                                                                                                                            <div class="form-group col-md-3">
                                                                                                                                                <label><?php echo e(trans('form.registration.client.state')); ?>
                                                                                                                                                    ...
                                                                                                                                                    <span class="text-danger">*</span></label>
                                                                                                                                                <input type="text" value="<?php echo e($address->state); ?>"
                                                                                                                                                       class="form-control multiple_input_required_s2 arr_address_state"
                                                                                                                                                       name="subjects[<?php echo e($subIndx); ?>][address][<?php echo e($addrIndx); ?>][state]"
                                                                                                                                                       id="state_<?php echo e($subIndx.'-'.$addrIndx); ?>"
                                                                                                                                            ...
                                                                                                                                            <div class="form-group col-md-3">
                                                                                                                                                <label><?php echo e(trans('form.registration.client.country')); ?>
                                                                                                                                                    ...
                                                                                                                                                    <span class="text-danger">*</span></label>
                                                                                                                                                <select name="subjects[<?php echo e($subIndx); ?>][address][<?php echo e($addrIndx); ?>][country_id]"
                                                                                                                                                        id="country_<?php echo e($subIndx.'-'.$addrIndx); ?>"
                                                                                                                                                    ...
                                                                                                                                                    <?php $__currentLoopData = $countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $country_name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                                                                                                        <option value="<?php echo e($country_name['id']); ?>" <?php echo e($address->country_id == $country_name['id'] ? 'selected' : ''); ?>><?php echo e(App::isLocale('hr')?$country_name['hr_name']:$country_name['en_name']); ?></option>
                                                                                                                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                                                                                                </select>
                                                                                                                                            </div>
                                                                                                                                            ...
                                                                                                                                            <div class="form-group col-md-3">
                                                                                                                                                ...
                                                                                                                                                <input type="text" value="<?php echo e($address->zipcode); ?>"
                                                                                                                                                       class="form-control numeric  arr_address_zip"
                                                                                                                                                       name="subjects[<?php echo e($subIndx); ?>][address][<?php echo e($addrIndx); ?>][zipcode]"
                                                                                                                                                       id="zipcode_<?php echo e($subIndx.'-'.$addrIndx); ?>"
                                                                                                                                            ...
                                                                                                                                            <div class="form-group col-md-4">
                                                                                                                                                ...
                                                                                                                                                <input type="text" id="arr_address_type_<?php echo e($subIndx.'-'.$addrIndx); ?>" value="<?php echo e($address->address_type??''); ?>" class="form-control multiple_input_required_s2 arr_address_type multiple_type_required_s2" name="subjects[<?php echo e($subIndx); ?>][address][<?php echo e($addrIndx); ?>][address_type]" placeholder="<?php echo e(trans('form.registration.client.address_type')); ?>" required>
                                                                                                                                                
                                                                                                                                            </div>

                                                                                                                                            <div id="arr_address_type_<?php echo e($subIndx.'-'.$addrIndx); ?>_div" class="form-group col-md-4 arr_add_other_text_div <?php echo e(($seloth == 0 ) ? 'd-block' : 'd-none'); ?>">
                                                                                                                                            <label class="address_other_no d-none"><?php echo e(trans('form.registration.client.type')); ?></label>

                                                                                                                                                <input onchange="changeothersubjecttitle(this);" type="text" id="arr_address_type_<?php echo e($subIndx.'-'.$addrIndx); ?>_otext" data-id="arr_address_type_<?php echo e($subIndx.'-'.$addrIndx); ?>"  value="<?php echo e(($seloth == 0) ? $address->address_type  : ''); ?>"
                                                                                                                                                       class="form-control numeric arr_add_other_text_type d-none"
                                                                                                                                                       name="subjects[<?php echo e($subIndx); ?>][address][<?php echo e($addrIndx); ?>][other_text]"
                                                                                                                                                       placeholder="<?php echo e(trans('form.registration.client.type_helper')); ?>"
                                                                                                                ...
                                                                                                                <tfoot>
                                                                                                                <tr><td id="address_footer" class="text-center" style="<?php echo e(!$subject->subject_addresses->isEmpty() ? 'display:none' : ''); ?>"> <?php echo e(trans('form.registration.deliveryboy.no_record_added')); ?> </td></tr>
                                                                                                                </tfoot>
                                                                                                            </table>
                                                                                                        </div>
                                                                                                    </div>
                                                                                                    <div class="form-row">
                                                                                                        <div class="col-md-12 text-right">
                                                                                                            <button type="button" onclick="addNewAddress(this)"
                                                                                                                    class="btn btn-link btn-lg waves-effect add-address-btn" id="<?php echo e($subIndx); ?>"
                                                                    ...
                                                                    <tfoot>
                                                                    <tr>
                                                                        <td id="contacts_footer" class="text-center" style="<?php echo e(!$invn->subjects->isEmpty() ? 'display:none' : ''); ?>"> <?php echo e(trans('form.registration.deliveryboy.no_record_added')); ?>
                                                    ...
                                                    <div class="form-group row mt-4">
                                                        <div class="col-12 text-right text-xs-center">
                                                            ...
                                                            <button 
                                                                ...
                                                                type="submit"><?php echo e(trans('general.update')); ?></button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
        ...
        <div class="row"
            ...
            <div class="col-sm-12 col-md-6 text-left">
                <h6 class="m-0 font-size-14">
                    ...
                    <label class="mt-2 ml-1 arr_contacts_address_confirmed_lable" data-on-label="<?php echo e(trans('general.yes')); ?>" data-off-label="<?php echo e(trans('general.no')); ?>"></label>
                    </div>
                </h6>
            </div>
            <div class="col-sm-12 col-md-6 text-sm-right">
    ...
    <div id="contact_collapse"
        ...
        <div class="card-body">
            ...
            <div class="form-row">
                ...
                <div class="form-group <?php echo e(($acflag)?'col-md-4 d-none':'col-md-4'); ?>">
                    <label for="invCost"><?php echo e(trans('form.registration.investigation.required_cost_invs')); ?>(<?php echo e(trans('general.money_symbol')); ?>) <span class="text-danger">*</span></label>
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-4">
                    ...
                    <select onchange="changeothertextbox(this);changesubjecttitlebyid(this.id);" name="subjects[][sub_type]" class="form-control arr_contacts_subType multiple_type_required_s2">
                        <?php $__currentLoopData = $subtypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($type['name']); ?>" <?php echo e(old('sub_type', $subject->sub_type) == $type['name'] ? 'selected' : ''); ?>>
                            <?php echo e(App::isLocale('hr')?$type['hr_name']:$type['name']); ?>
    ...
    <div id="address_collapse"
        ...
        <div class="card-body">
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-4">
                    <label><?php echo e(trans('form.registration.client.address_type')); ?></label>
                    <input type="text" class="form-control multiple_input_required_s2 arr_address_type multiple_type_required_s2" name="subjects[]['address'][]['address_type']" placeholder="<?php echo e(trans('form.registration.client.address_type')); ?>" required>
...
<script>
    $(document).ready(function () {
        ...
        var oldArr = <?php echo json_encode($oldArr); ?>;
        ...
        $(".userinquiry_dd").on('change', function(e){
            ...
            var status='<?php echo e($invn->status); ?>';
            /* if(status=='Open'){
                ...
                success:function (response) {
                    ...
                    if (response.status == 'success') {
                        ...
                        $.each(response.data, function(key, value) {
                            ...
                            var intypeinq='<?php echo e($invn->type_of_inquiry); ?>';
                            var paying_customerid='<?php echo e($invn->paying_customerid); ?>';
                    ...
                    if(isIdNull){
                        Swal.fire({
                            ...
                            if(result.value){
                                ...
                                var url = '/investigations/' + '<?php echo e($invn->id); ?>';
                                    ...
                                    success: function (response) {
                                        if (response.status == 'success') {
                                            Swal.fire({
                                                ...
                                                text: (response.message) ? response.message : "<?php echo e(trans('form.registration.investigation.investigation_updated')); ?>", 
                                                type: "success",
                                                confirmButtonText: "<?php echo e(trans('general.ok')); ?>",
                                            })
                                                .then((result) => {
                                            ...
                                            $('.create-btn').text("<?php echo e(trans('general.update')); ?>");
                                        }
                                    },
    ...
    function customFormValidation()
    {
        ...
        $('.arr_contacts_passport').each(function (index, object){
            ...
            if(allow){
                if(allow == 'no'){
                    let errorEle = $('#id-passport-error-'+(index+1));
                    console.log(errorEle,'here');
                    errorEle.css('display', 'block');
                    errorEle.html('<?php echo e(trans('form.registration.investigation.id_passport_error')); ?>')
                    // statusId = false;
    ...
    function calccode(e) {
        ...
        console.log($(this).hasClass('arr_contacts_spouses'),'this')
...
<script type="text/javascript">
    window.onload = function() {
       ...
       /*  addinputmask('arr_contacts_secondaryphones');
        ...
        ?>
                    setoldadderess(<?php echo e($i+1); ?>, <?php echo e($j+1); ?>);
        <?php
                }
            }
        ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/uvda/resources/views/investigation/edit.blade.php ENDPATH**/ ?>