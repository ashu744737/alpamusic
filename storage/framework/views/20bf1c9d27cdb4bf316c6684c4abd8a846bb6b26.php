<?php $__env->startSection('title'); ?> <?php echo e(trans('form.registration.deliveryboy.create_deliveryboy_title')); ?> <?php $__env->stopSection(); ?>
    ...
    <div class="col-sm-6">
        <div class="page-title-box">
            <ol class="breadcrumb m-0">
                <li class="breadcrumb-item"><a href="<?php echo e(route('deliveryboys')); ?>"><?php echo e(trans('form.deliveryboys')); ?></a></li>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <h4 class="card-title"><?php echo e(trans('form.registration.deliveryboy.create_deliveryboy_title')); ?></h4>
                            <p class="card-title-desc"><?php echo e(trans('form.registration.deliveryboy.create_deliveryboy_desc')); ?></p>
                        </div>

                        <div class="col-12">

                            <form name="deliveryboy-form" id="deliveryboy-form" class="form-horizontal mt-4" method="POST" action="<?php echo e(route('deliveryboy.store')); ?>" onSubmit="return dosubmit();" >
...
unset($__errorArgs, $__bag); ?>
                                                        ...
                                                        <div class="form-row">
                                                            <!-- delivery areas -->
                                                            <div class="form-group col-md-6">
                                                                <label><?php echo e(trans('form.registration.deliveryboy.delivery_areas')); ?> <span class="text-danger">*</span></label>
                                                                <select multiple="multiple" class="select2 form-control select2-multiple input_required_s2" id="deliveryarea_id" name="deliveryarea_id[]" data-placeholder="<?php echo e(trans('form.registration.deliveryboy.delivery_helper')); ?>">
                                                                    <?php $__currentLoopData = $deliveryareas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $deliveryarea): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                        <option value="<?php echo e($deliveryarea['id']); ?>" <?php echo e(old('deliveryarea_id') == $deliveryarea['id'] ? 'selected' : ''); ?>>
                                                                        <?php echo e(App::isLocale('hr')?$deliveryarea['hr_area_name']:$deliveryarea['area_name']); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/uvda/resources/views/deliveryboys/create.blade.php ENDPATH**/ ?>