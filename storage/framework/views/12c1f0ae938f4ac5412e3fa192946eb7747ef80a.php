<?php $__env->startSection('title'); ?> <?php echo e(trans('form.registration.investigator.create_investigator_title')); ?> <?php $__env->stopSection(); ?>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <h4 class="card-title"><?php echo e(trans('form.registration.investigator.create_investigator_title')); ?></h4>
                            <p class="card-title-desc"><?php echo e(trans('form.registration.investigator.create_investigator_desc')); ?></p>
                        </div>

                        <div class="col-12">

                            <form name="investigator-form" id="investigator-form" class="form-horizontal mt-4" method="POST" action="<?php echo e(route('investigator.store')); ?>" onSubmit="return dosubmit();" >
...
unset($__errorArgs, $__bag); ?>" name="email" value="<?php echo e(old('email')); ?>" id="useremail" placeholder="<?php echo e(trans('form.enter_email')); ?>" autocomplete="email" >
...
unset($__errorArgs, $__bag); ?>" name="password" autocomplete="new-password" id="userpassword" placeholder="<?php echo e(trans('form.enter_password')); ?>">
...
unset($__errorArgs, $__bag); ?>
                                                            ...
                                                            <div class="form-group col-md-6">
                                                                ...
                                                                <input type="password" minlength="8" name="password_confirmation" class="form-control" id="userconfirmpassword" placeholder="<?php echo e(trans('form.registration.confirm_password')); ?>">
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div id="next_step2">
                                                        ...
                                                        <div class="form-row">
                                                            <div class="form-group col-md-4">
                                                                ...
                                                                <input type="text" value="" class="form-control" id="family" name="family" placeholder="<?php echo e(trans('form.registration.investigator.family')); ?>">
...
unset($__errorArgs, $__bag); ?>
                                                            ...
                                                            <div class="form-group col-md-4">
                                                                ...
                                                                <input type="text" value="" class="form-control" id="idnumber" name="idnumber" placeholder="<?php echo e(trans('form.registration.investigator.id_number')); ?>">
                                                        ...
                                                        <div class="form-row">
                                                            <div class="form-group col-md-6">
                                                                ...
                                                                <select multiple="multiple" class="select2 form-control select2-multiple input_required_s2" id="specializations" name="specializations[]" data-placeholder="<?php echo e(trans('form.registration.investigator.fos_helper')); ?>">
                                                                    <?php $__currentLoopData = $specializations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $specialization): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                        <option value="<?php echo e($specialization['id']); ?>" <?php echo e(old('specializations') == $specialization['id'] ? 'selected' : ''); ?>>
                                                            ...
                                                            <div class="form-group col-md-6">
                                                                ...
                                                                <div class="input-group">
                                                                    <input type="text" class="form-control" placeholder="<?php echo e(trans('general.date_format')); ?>" id="dob" name="dob">
											...
											<div class="table-responsive mb-0 fixed-solution"
												...
												<div id="emails_tbl">
													<table class="table table-borderless mb-0">
														...
														<tfoot>
														<tr>
															<td id="email_footer" class="text-center"> <?php echo e(trans('form.registration.deliveryboy.no_record_added')); ?>
											...
											<div class="table-responsive mb-0 fixed-solution"
												...
												<div id="emails_tbl">
													<table class="table table-borderless mb-0">
														...
														<tfoot>
														<tr>
															<td id="phone_footer" class="text-center"> <?php echo e(trans('form.registration.deliveryboy.no_record_added')); ?>
											...
											<div class="table-responsive mb-0 fixed-solution"
												...
												<div id="emails_tbl">
													<table class="table table-borderless mb-0">
														...
														<tfoot>
														<tr>
															<td id="mobile_footer" class="text-center"> <?php echo e(trans('form.registration.deliveryboy.no_record_added')); ?>
											...
											<div class="table-responsive mb-0 fixed-solution"
												...
												<div id="emails_tbl">
													<table class="table table-borderless mb-0">
														...
														<tfoot>
														<tr>
															<td id="fax_footer" class="text-center"> <?php echo e(trans('form.registration.deliveryboy.no_record_added')); ?>
...
unset($__errorArgs, $__bag); ?>"
                                                                       ...
                                                                       placeholder="<?php echo e(trans('form.registration.investigator.name_of_bank')); ?>">
                                                                </select>
...
unset($__errorArgs, $__bag); ?>
                                                            ...
                                                            <div class="form-group col-md-6">
                                                                ...
                                                                <input type="text"
                                                                       class="form-control  <?php $__errorArgs = ['bank_number'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                                            ...
                                                            <div class="form-group col-md-4">
                                                                ...
                                                                <input type="text" class="form-control  <?php $__errorArgs = ['branch_no'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                                            ...
                                                            <div class="form-group col-md-4">
                                                                ...
                                                                <input type="text" class="form-control <?php $__errorArgs = ['account_no'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                                        ...
                                                        <div class="form-group cptch-container">
                                                            <div class="g-recaptcha m-b-10" data-sitekey="<?php echo e(env('GOOGLE_RECAPTCHA_SITE_KEY')); ?>"></div>
...
<?php $__env->startSection('footerScript'); ?>
    ...
    <script>
        ...
        function deleteAddress(ele)
        {
            ...
            if ($(".address-base-row").length < 1) {
                $("#address_footer").html('<span><?php echo e(trans("general.no_record_added")); ?></span>');
                $("#address_footer").show();
            }
        }
		...
		function deleteEmail(ele) {
			...
			if ($(".email-base-row").length < 1) {
				$("#email_footer").html('<span><?php echo e(trans("general.no_record_added")); ?></span>');
				$("#email_footer").show();
			}
		}
		...
		function deletePhone(ele) {
			...
			if ($(".phone-base-row").length < 1) {
				$("#phone_footer").html('<span><?php echo e(trans("general.no_record_added")); ?></span>');
				$("#phone_footer").show();
			}
		}
		...
		function deleteMobile(ele) {
			...
			if ($(".mobile-base-row").length < 1) {
				$("#mobile_footer").html('<span><?php echo e(trans("general.no_record_added")); ?></span>');
				$("#mobile_footer").show();
			}
		}
		...
		function deleteFax(ele) {
			...
			if ($(".fax-base-row").length < 1) {
				$("#fax_footer").html('<span><?php echo e(trans("general.no_record_added")); ?></span>');
				$("#fax_footer").show();
			}
		}
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/uvda/resources/views/investigators/create.blade.php ENDPATH**/ ?>