<?php $__env->startSection('title'); ?> <?php echo e(trans('form.dashboard')); ?> <?php $__env->stopSection(); ?>
...
<?php $__env->startSection('content'); ?>              
    ...
    <div class="row">
        ...
        <?php echo $__env->make('dashboard.investigator', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>       
        <?php endif; ?>
        <?php if(isDeliveryboy()): ?>
        <?php echo $__env->make('dashboard.deliveryboy', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <?php endif; ?>
        <?php if(isClient()): ?>
        <?php echo $__env->make('dashboard.client', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <?php endif; ?>  
        <?php if(isSM()): ?>
        <?php echo $__env->make('dashboard.stationmanager', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <?php endif; ?>
        <?php if(isAccountant()): ?>
...
<!--Morris Chart-->
    ...
    <script>
        ...
        let days = '<?php echo e(trans("form.dashboard_screen.days")); ?>'
        let cost = '<?php echo e(trans("form.dashboard_screen.cost")); ?>'
        let service = '<?php echo e(trans("form.dashboard_screen.service")); ?>';
        let total_income = '<?php echo e(trans("form.dashboard_screen.total_income")); ?>';
        let total_outcome = '<?php echo e(trans("form.dashboard_screen.total_outcome")); ?>';
        let open = '<?php echo e(trans("form.dashboard_screen.open")); ?>';
        let closed = '<?php echo e(trans("form.dashboard_screen.closed")); ?>';
        let pendingapproval = '<?php echo e(trans("form.investigation_status.PendingApproval")); ?>';
        let costPerType = '<?php echo e(trans("form.dashboard_screen.cost_per_type")); ?>';
        let costOfInvestigator = '<?php echo e(trans("form.dashboard_screen.cost_of_investigator")); ?>';
        let amount = '<?php echo e(trans("form.dashboard_screen.amount")); ?>';
        let complaints = '<?php echo e(trans("form.dashboard_screen.complaints")); ?>';
        let income = '<?php echo e(trans("form.dashboard_screen.income")); ?>';
        let moneySymbole = '<?php echo e(trans("general.money_symbol")); ?>';
        let currentLogintype = "<?php echo config('constants.user_type') ?>";
        let invInvoiceAmt = '<?php echo e(trans("form.inv_invoice_amount")); ?>';
        let delInvoiceAmt = '<?php echo e(trans("form.del_invoice_amount")); ?>';
        ...
        function refreshChart(chart, year) {
            $.ajax({
                url: '<?php echo e(route("chart.refresh")); ?>',
                type: 'post',
                data: {
                    chart: chart,
                    year: year,
                ...
                success: function(result){
                    ...
                    if($('#income_outcome_chart').length && year == 'current'){
                      ...
                      $('#totalOutcome').html('<?php echo e(trans("general.money_symbol")); ?>'+(result.totalOutCome?result.totalOutCome:0));
                      $('#totalIncome').html('<?php echo e(trans("general.money_symbol")); ?>'+(result.totalIncome?result.totalIncome:0));
                        var $donutData = [
                          {
                            label: total_income,
                    ...
                    if(result.investigationCount){
                        if(result.investigationCount.length > 0){
                            if($('#complete_incomplete_investigation').length){
                                var $donutData = [
                                  {
                                    label: "<?php echo e(trans('form.investigator_investigation_status.InProgress')); ?>",
                                    value: result.investigationCount[0].in_progress
                                  },{
                                    label: "<?php echo e(trans('form.investigator_investigation_status.Completed')); ?>",
                                    value: result.investigationCount[0].total_completed
                                  }, {
                                    label: "<?php echo e(trans('form.investigator_investigation_status.NotCompleted')); ?>",
                                    value: result.investigationCount[0].total_not_completed
                                  }
                                  , {
                                    label: "<?php echo e(trans('form.investigator_investigation_status.ReportWriting')); ?>",
                                    value: result.investigationCount[0].report_writing
                                  }, {
                                    label: "<?php echo e(trans('form.investigator_investigation_status.ReportSubmitted')); ?>",
                                    value: result.investigationCount[0].report_submitted
                                  }
                                  , {
                                    label: "<?php echo e(trans('form.investigator_investigation_status.Declined')); ?>",
                    ...
                    if(result.deliveriesCount){
                        if(result.deliveriesCount.length > 0){
                            if($('#complete_incomplete_deliverys').length){
                                var $donutData = [
                                    {
                                    label: "<?php echo e(trans('form.deliveryboy_investigation_status.InProgress')); ?>",
                                    value: result.deliveriesCount[0].in_progress
                                  },
                                  {
                                    label: "<?php echo e(trans('form.deliveryboy_investigation_status.Delivered')); ?>",
                                    value: result.deliveriesCount[0].total_completed
                                  }, {
                                    label: "<?php echo e(trans('form.deliveryboy_investigation_status.NotDelivered')); ?>",
                                    value: result.deliveriesCount[0].total_not_completed
                                  },
                                  {
                                    label: "<?php echo e(trans('form.deliveryboy_investigation_status.ReportWriting')); ?>",
                                    value: result.deliveriesCount[0].report_writing
                                  },
                                  {
                                    label: "<?php echo e(trans('form.deliveryboy_investigation_status.ReportSubmitted')); ?>",
                    ...
                    if(result.topInvestigators) {
                        if(result.topInvestigators.length > 0){
                            if($('#top_10_investigators').length){
                                ...
                                let html = ``;
                                let open_cases = '<?php echo e(trans("form.investigator.open_cases")); ?>';
                                let completed = '<?php echo e(trans("form.investigator.completed")); ?>';
                                let not_completed = '<?php echo e(trans("form.investigator.not_completed")); ?>';
                        ...
                        penInvestigationsHTML += '<?php echo e(trans("general.no_record_found")); ?>';
                    ...
                    if(result.topDeliveryboys) {
                        if(result.topDeliveryboys.length > 0){
                            if($('#top_10_delivery').length){
                                ...
                                let open_cases = '<?php echo e(trans("form.investigation.search.open_cases")); ?>';
                                let completed = '<?php echo e(trans("form.investigation.search.delivered")); ?>';
                                let not_completed = '<?php echo e(trans("form.investigation.search.not_delivered")); ?>';
                    ...
                    if($('#late-investigations').length) {
                        let employeeEfficiencyData = [
                            {
                              y: "<?php echo e(trans('general.month.Jan')); ?>",
                              a: 5,
                            }, {
                              y: "<?php echo e(trans('general.month.Feb')); ?>",
                              a: 7,
                            }, {
                              y: "<?php echo e(trans('general.month.Mar')); ?>",
                              a: 9,
                            }, {
                              y: "<?php echo e(trans('general.month.Apr')); ?>",
                              a: 2,
                            }, {
                              y: "<?php echo e(trans('general.month.May')); ?>",
                              a: 0,
                            }, {
                              y: "<?php echo e(trans('general.month.Jun')); ?>",
                              a: 13,
                            }, {
                              y: "<?php echo e(trans('general.month.Jul')); ?>",
                              a: 6,
                            }, {
                              y: "<?php echo e(trans('general.month.Aug')); ?>",
                              a: 7,
                            }, {
                              y: "<?php echo e(trans('general.month.Sept')); ?>",
                              a: 10,
                            }, {
                              y: "<?php echo e(trans('general.month.Oct')); ?>",
                              a: 15,
                            }, {
                              y: "<?php echo e(trans('general.month.Nov')); ?>",
                              a: 17,
                            }, {
                              y: "<?php echo e(trans('general.month.Dec')); ?>",
                              a: 19,
                            }
                        ];
                    ...
                    if(result.clientInvestigationCount){
                        if(result.clientInvestigationCount.length > 0){
                            if($('#complete_incomplete_client').length){
                                var $donutData = [
                                    {
                                    label: "<?php echo e(trans('form.investigation_status.Waiting')); ?>",
                                    value: result.clientInvestigationCount[0].waiting
                                  },
                                  {
                                    label: "<?php echo e(trans('form.timeline_status.In Progress')); ?>",
                                    value: result.clientInvestigationCount[0].in_progress
                                  }, {
                                    label: "<?php echo e(trans('form.timeline_status.Closed')); ?>",
                    ...
                    if(currentLogintype=="<?php echo e(env('USER_TYPE_STATION_MANAGER')); ?>"){
                    ...
                    if(monthlyinvestigationData && monthlyinvestigationData.length > 0){
                        ...
                        if($('#monthly-investigations-chart').length){
                            ...
                            createLineChart('monthly-investigations-chart', monthlyinvestigationData, 'y', ['a'], ['<?php echo e(trans("form.dashboard_screen.investigations")); ?>'], ['#dc86ef'], true, ''); //creating bar chart   
                        }
                    ...
                    if(result.time_per_case){
                      if(timePerCase && timePerCase.length > 0){
                        if($('#time-per-case-type').length){
                          ...
                          if($('#time-per-case-type').length){
                              $("#time-per-case-type").empty();
                              let incomePerEmpHTML = '<div style="text-align: center;"><?php echo e(trans("general.no_record_found")); ?></div>';
                    ...
                    if(result.paymentPaidToInvDel){
                      if(paymentPaidToInvDel && paymentPaidToInvDel.length > 0){
                        ...
                        $('#inv_del_invoice_amt').html(`<?php echo e(trans('general.money_symbol')); ?> ${totalAmt}`);
                        createLineChart('payments-line-example', result.paymentPaidToInvDel, 'y', ['a', 'b'], [invInvoiceAmt, delInvoiceAmt], ['#7a6fbe', '#28bbe3'], true, '<?php echo e(trans("general.money_symbol")); ?>'); //creating bar chart   
                      } else {
                        $('#inv_del_invoice_amt').html(`<?php echo e(trans('general.money_symbol')); ?> 0`);
                        let incomePerEmpHTML = '<?php echo e(trans("general.no_record_found")); ?>';
                    ...
                    if(result.paymentNotRev){
                      if(paymentNotRev && paymentNotRev.length > 0) {
                        ...
                        $('#total_payment_not_rec').html(`<?php echo e(trans('general.money_symbol')); ?> ${totalAmt}`);
                        createLineChart('pending-payments-line-example', paymentNotRev, 'y', ['a'], [amount], ['#FD545E'], true, '<?php echo e(trans("general.money_symbol")); ?>'); //creating bar chart   
                      } else {
                        $('#total_payment_not_rec').html(`<?php echo e(trans('general.money_symbol')); ?> 0`);
                        let incomePerEmpHTML = '<?php echo e(trans("general.no_record_found")); ?>';
                    ...
                    if(result.incomePerEmp){
                      if(incomePerEmp && incomePerEmp.length > 0){
                            ...
                            incomePerEmpHTML += `<tr>
                                                  ...
                                                  <td>
                                                    <div style="display: inline-flex;">
                                                      ...
                                                      <div><?php echo e(trans('general.money_symbol')); ?>${income.diff}</div>
                                                    </div>
                                                  </td>
                                              </tr>`;
                          });
                        ...
                        incomePerEmpHTML = `<tr>
                                                  <td colspan="2" style="text-align: center;">`;
                          incomePerEmpHTML += '<?php echo e(trans("general.no_record_found")); ?>';
                          incomePerEmpHTML += `</td>
                                                  </tr>`;
                          $('#monthly-income-employee-tab').html(incomePerEmpHTML)
                      }
                    ...
                    if(result.complaintsPerClient){
                      if(complaintsPerClient && complaintsPerClient.length > 0){
                        ...
                        complaintsPerClientHTML = `<tr>
                                                  <td colspan="2" style="text-align: center;">`;
                          complaintsPerClientHTML += '<?php echo e(trans("general.no_record_found")); ?>';
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/uvda/resources/views/dashboard/index.blade.php ENDPATH**/ ?>